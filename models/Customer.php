...
class Customer {
    ...
    public function create(){
        ...
        $stmt = $this->db->prepare("INSERT INTO customers(customer, alias, id_cost_center, created_at, modified_at) VALUES (:customer, :alias, :id_cost_center, GETDATE(), GETDATE());");
    ...
    public function update(){
        ...
        $stmt = $this->db->prepare("UPDATE customers SET customer = :customer, alias = :alias, id_cost_center = :id_cost_center, modified_at = GETDATE() WHERE id = :id;");
        $stmt->bindParam(":customer", $customer, PDO::PARAM_STR);
        $stmt->bindParam(":alias", $alias, PDO::PARAM_STR);
        $stmt->bindParam(":id_cost_center", $id_cost_center, PDO::PARAM_INT);
        $stmt->bindParam(":id", $id, PDO::PARAM_INT);
