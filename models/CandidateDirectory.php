...
class CandidateDirectory
{
	...
	public function save_candidate()
	{
		...
		$stmt = $this->db->prepare("INSERT INTO root.candidate_directory (first_name,surname,last_name,telephone,age,experience,id_state,id_city,email,url,comment,created_at,id_vacancy,status,created_by,date_birth,id_civil_status,description,cellphone,id_area,id_subarea,id_gender,modified_at ) VALUES (:first_name,:surname,:last_name,:telephone,:age,:experience,:id_state,:id_city,:email,:url,:comment,GETDATE(),:id_vacancy,:status,:created_by,:date_birth,:id_civil_status,:description,:cellphone,:id_area,:id_subarea,:id_gender,GETDATE())");
