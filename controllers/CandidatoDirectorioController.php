...
class CandidatoDirectorioController
{
    ...
    public function index()
    {
        ...
        // var_dump(Utils::decrypt('NHlkSU5adFZvVTFMLzg0NzJCbjhLQT09Ojo9qinTgZVBX2aiNVB1F2y2'));
        // die();
...

    {
        ...
        foreach ($candidatesDirector as &$candidate) {
            ...
            //GABO 11 OCT
            $candidate['modified_at'] =    $candidate['modified_at'] != ''  ?  Utils::getFullDate12($candidate['modified_at'])  : '';
