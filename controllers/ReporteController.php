...
class ReporteController {
	...
	public function employeesinformation()
    {
        ...
        $employees = $employee->getEmployeesAllInformation();
        ...
        $arrayColumns = array(
            ...
            array('pColumn' => 'K', 'row' => $row, 'value' => 'Fecha de nacimiento'),
            array('pColumn' => 'L', 'row' => $row, 'value' => 'Edad'),
            array('pColumn' => 'M', 'row' => $row, 'value' => 'NSS'),
            array('pColumn' => 'N', 'row' => $row, 'value' => 'RFC'),
            array('pColumn' => 'O', 'row' => $row, 'value' => 'CURP'),
            array('pColumn' => 'P', 'row' => $row, 'value' => 'Correo electrónico personal'),
            array('pColumn' => 'Q', 'row' => $row, 'value' => 'Correo electrónico empresarial'),
            array('pColumn' => 'R', 'row' => $row, 'value' => 'Telefono 1'),
            array('pColumn' => 'S', 'row' => $row, 'value' => 'Telefono 2'),
            array('pColumn' => 'T', 'row' => $row, 'value' => 'Estado civíl'),
            array('pColumn' => 'U', 'row' => $row, 'value' => 'Conyugue'),
            array('pColumn' => 'V', 'row' => $row, 'value' => 'Hijos'),
            array('pColumn' => 'W', 'row' => $row, 'value' => 'Padre'),
            array('pColumn' => 'X', 'row' => $row, 'value' => 'Madre'),
            array('pColumn' => 'Y', 'row' => 2, 'value' => 'Periodo de prueba'),
            array('pColumn' => 'X', 'row' => 2, 'value' => 'Capacitación inicial'),
            array('pColumn' => 'Z', 'row' => 2, 'value' => 'Tiempo determinado'),
            array('pColumn' => 'AA', 'row' => 2, 'value' => 'Tiempo indeterminado'),
        ...
        foreach ($arrayColumns as $data) {
            if (($data['pColumn'] == 'Y' || $data['pColumn'] == 'Z' || $data['pColumn'] == 'AA' || $data['pColumn'] == 'AB' || $data['pColumn'] == 'AC') && $data['row'] == 2) {
        ...
        $hoja->mergeCells('Y1:AC1');
        $hoja->getColumnDimension('Y')->setAutoSize(true);
        $hoja->setCellValueByColumnAndRow(25, 1, 'Contratos');
        ...
        foreach ($employees as $emp) {
            $hoja->setCellValueByColumnAndRow(1, $row, $emp['employee_number']);
            $hoja->setCellValueByColumnAndRow(2, $row, $emp['fullName']);
            $hoja->setCellValueByColumnAndRow(3, $row, $emp['title']);
            $hoja->setCellValueByColumnAndRow(4, $row, $emp['boss_title_position']);
            $hoja->setCellValueByColumnAndRow(5, $row, $emp['department']);
            $hoja->setCellValueByColumnAndRow(6, $row, $emp['id_gender'] == 1 ? 'Hombre' : 'Mujer');
            $hoja->setCellValueByColumnAndRow(7, $row, Utils::getDate($emp['start_date']));
            $hoja->setCellValueByColumnAndRow(8, $row, $emp['antiquity'] . ' Años');
            $hoja->setCellValueByColumnAndRow(9, $row, isset($emp['history_position_date']) ? Utils::getDate($emp['history_position_date']) : '');
            $hoja->setCellValueByColumnAndRow(10, $row, isset($emp['employee_payroll']) ? Utils::getDate($emp['employee_payroll']) : '');
            $hoja->setCellValueByColumnAndRow(11, $row,  isset($emp['date_birth']) ? Utils::getDate($emp['date_birth']) : '');
            $hoja->setCellValueByColumnAndRow(12, $row, $emp['age'] . ' Años');
            $hoja->setCellValueByColumnAndRow(13, $row, $emp['nss']);
            $hoja->setCellValueByColumnAndRow(14, $row, $emp['rfc']);
            $hoja->setCellValueByColumnAndRow(15, $row, $emp['curp']);
            $hoja->setCellValueByColumnAndRow(16, $row, $emp['email']);
            $hoja->setCellValueByColumnAndRow(17, $row, $emp['institutional_email']);
            $hoja->setCellValueByColumnAndRow(18, $row, $emp['phone1']);
            $hoja->setCellValueByColumnAndRow(19, $row, $emp['phone2']);
            $hoja->setCellValueByColumnAndRow(20, $row, $emp['civil_status']);
            $hoja->setCellValueByColumnAndRow(22, $row, $emp['daughter'] + $emp['son']);
            $hoja->setCellValueByColumnAndRow(23, $row, $emp['father']);
            $hoja->setCellValueByColumnAndRow(24, $row, $emp['mother']);
            $hoja->setCellValueByColumnAndRow(25, $row, isset($emp['contract_start1']) ? Utils::getDate($emp['contract_start1']) . ' - ' . Utils::getDate($emp['contract_end1']) : '');
            $hoja->setCellValueByColumnAndRow(26, $row, isset($emp['contract_start2']) ? Utils::getDate($emp['contract_start2']) . ' - ' . Utils::getDate($emp['contract_end2']) : '');
            $hoja->setCellValueByColumnAndRow(27, $row, isset($emp['contract_start4']) ? Utils::getDate($emp['contract_start4']) . ' - ' . Utils::getDate($emp['contract_end4']) : '');
            $hoja->setCellValueByColumnAndRow(28, $row, isset($emp['contract_start5']) ? Utils::getDate($emp['contract_start5']) : '');
