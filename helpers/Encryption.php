...
class Encryption{
    ...
    public static function encode($value=false){ 
        ...
        $crypttext = openssl_encrypt($value, 'aes-256-cbc', 'r3c1ut4m13nt0', OPENSSL_RAW_DATA, $iv);
    ...
    public static function decode($value=false){
        ...
        $decrypttext = openssl_decrypt($crypttext, 'aes-256-cbc', 'r3c1ut4m13nt0', OPENSSL_RAW_DATA, $iv);
