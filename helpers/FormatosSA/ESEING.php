...
class ESEINGE extends FPDF
{
	...
	public function setPortada($candidato, $viabilidad)
	{
		...
		$this->Write(48, 'VERIFICATION');

		$y = $this->GetY() + 53;
		$this->SetXY($x, $y);
		$this->Write(48, utf8_encode('REPORT'));

		/* $this->setTextColor(158, 198, 58);
		$y = $this->GetY() + 53;
		$this->SetXY($x, $y);
		$this->Write(48, 'DOMICILIARIA'); */
		...
		} else if ($candidato->Cliente == 366 || $this->id_cliente == 673  || $this->id_cliente == 598 || $this->id_cliente == 593 || $this->id_cliente == 599) {
		...
		if (!empty($candidato->Verificador) && ($candidato->Verificador) <> ' ') {
			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(32, 685);
			$this->MultiCell(250, 10, utf8_encode('Home checker: '), 0, 'L', true);
	...
	public function setDatosGenerales($candidato, $foto)
	{
		...
		$this->setTextColor(0, 0, 0);
		$this->setXY(75, $y);
	if($candidato->Cliente ==366||$candidato->Cliente ==626  || $candidato->Cliente ==668  || $this->id_cliente == 673 || $this->id_cliente == 598 || $this->id_cliente == 593 || $this->id_cliente == 599){
		...
		$y = $this->GetY() + 5;
		$this->SetXY($x, $y);
		$this->MultiCell(52, 8, utf8_encode('Application date'), 0, 'L', false);

		$this->setFont('SinkinSans', '', 6.5);
		$this->setTextColor(0, 0, 0);
		$this->setXY(75, $y);
		$this->MultiCell(410, 18, $candidato->Fecha_Aplicacion ? substr(date('r', strtotime($candidato->Fecha_Aplicacion)), 0, 16)  : '', 0, 'C', true);
	...
	public function setDatosPersonales($candidato, $docs)
	{
		$y = $this->GetY() + 25;
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x1 + 126, $y);
		$this->MultiCell(50, 18, utf8_encode('Gender'), 0, 'L', false);
		...
		$this->setTextColor(0, 0, 0);
		$this->setXY($x1 + 60, $y);
		$this->MultiCell(55, 18, utf8_encode(Utils::getEstadoCivilIng($candidato->Estado_Civil)), 0, 'C', true);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(123, 18, utf8_encode('Marriage date'), 0, 'L', false);

		$this->setXY(123, $y);

		$this->setFont('SinkinSans', '', 6.5);
		$this->setTextColor(0, 0, 0);
		$resultadoMatrimonio = empty($candidato->Fecha_Matrimonio) || $candidato->Fecha_Matrimonio == NULL ? 'Does not apply' : $candidato->Fecha_Matrimonio;
		$this->MultiCell(182, 18, utf8_encode($resultadoMatrimonio), 0, 'C', true);*/

		$this->setFont('SinkinSans', 'B', 6.5);
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x1 + 126, $y);
		$this->MultiCell(200, 18, utf8_encode('Number of children'), 0, 'L', false);

		$this->setFont('SinkinSans', '', 6.5);
		$this->setTextColor(0, 0, 0);
		$this->setXY($x1 + 220, $y);
		$this->MultiCell(60, 18, $candidato->Hijos, 0, 'C', true);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(123, 18, utf8_encode('Nationality'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x1, $y);
		$this->MultiCell(56, 18, utf8_encode('Lives with'), 0, 'L', false);
		...
		$this->setTextColor(0, 0, 0);
		$this->setXY(70, $y);
		$this->MultiCell(98, 18, utf8_encode($candidato->CURP), 0, 'C', true);
		...
		if ($candidato->Numero_Licencia != null || $candidato->Numero_Licencia != '') {
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY(150, $y);
			$this->MultiCell(93, 18, utf8_encode('License number'), 0, 'L', false);
	...
	public function setDatosContacto($candidato, $domicilio)
	{
		...
		$this->SetFillColor(255, 255, 255);
		$this->SetXY($x, $y);
		$this->MultiCell(50, 15, 'Residence', 0, 'L', false);
		...
		if ($candidato->Telefono_fijo) {
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x1 + 150, $y);
			$this->MultiCell(50, 18, utf8_encode('Home phone'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(50, 15, 'Email', 0, 'C', false);
	...
	public function setDocumentacionPresentada($doc_adjuntos, $Comentario)
	{
		...
		$y += 6;
		$this->setXY(220, $y);
		$this->Write(10, utf8_encode('DOCUMENTATION SUBMITTED'));
		...
		$this->SetFillColor(255, 255, 255);
		$this->SetXY(455, $y);
		$this->MultiCell(150, 15, utf8_encode('Presented original document'), 0, 'C', false);

		$y = $this->GetY() + 5;
		$this->SetXY($x, $y);
		$this->Write(15, utf8_encode('Document'));

		$y = $this->GetY() + 5;
		$this->SetXY(455, $y);
		$this->MultiCell(70, 15, utf8_encode('Yes'), 0, 'C', false);
		...
		$y = $this->GetY() + 5;
		$this->SetXY($x, $y);
		$this->MultiCell(425, 10, utf8_encode('Personal identification on both sides'), 0, 'L');
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(425, 10, utf8_encode('Proof of addres'), 0, 'L');
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(425, 10, utf8_encode('Birth certificate'), 0, 'L');
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(425, 10, utf8_encode('Labor letters'), 0, 'L');
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(425, 10, utf8_encode('INFONAVIT Release or Retention Notice'), 0, 'L');
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(65, 10, utf8_encode('Comments'), 0, 'L');
	...
	public function setEstudios($escolaridad, $comentarios)
	{
		...
		$y += 6;
		$this->setXY(220, $y);
		$this->Write(10, utf8_encode('LATEST STUDIES'));
		...
		foreach ($escolaridad as $estudio) {
			...
			if ($estudio['Grado'] == 336) {
				...
				$this->SetFillColor(255, 255, 255);
				$this->setXY($x, $y);
				$this->MultiCell(80, 15, utf8_encode('Grade'), 0, 'C', false);
				$this->setXY($x + 290, $y);
				$this->MultiCell(80, 15, utf8_encode('Comments'), 0, 'C', false);
				...
				$this->setXY(22, $y);
				$this->MultiCell(90, 8, utf8_encode(Utils::getGradoEstudioIng($estudio['Grado'])), 0, 'C', true);
				...
				$this->SetFillColor(255, 255, 255);
				$this->setXY($x, $y);
				$this->MultiCell(97, 15, utf8_encode('Grade'), 0, 'L', false);
				$this->setXY($x + 99, $y);
				$this->MultiCell(136, 15, utf8_encode('Institution name'), 0, 'C', false);
				$this->setXY($x + 238, $y);
				$this->MultiCell(70, 15, utf8_encode('Place'), 0, 'C', false);
				$this->setXY($x + 310, $y);
				$this->MultiCell(80, 15, utf8_encode('Period'), 0, 'C', false);
				$this->setXY($x + 392, $y);
				$this->MultiCell(80, 15, utf8_encode('Document'), 0, 'C', false);
				$this->setXY($x + 475, $y);
				...
				$this->setXY(12, $y);
				$this->MultiCell(110, 8, utf8_encode(Utils::getGradoEstudioIng($estudio['Grado'])), 0, 'C', true);
				$this->setXY($x + 99, $y);
				...
				$this->setXY($x + 392, $y);
				$this->MultiCell(80, 8, utf8_encode(Utils::getDocumentoEscolarIng($estudio['Documento'])), 0, 'C', true);
				$this->setXY($x + 475, $y);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(97, 10, utf8_encode('Comments'), 0, 'L');
	...
	public function setCohabitantes($cohabitantes, $comentarios)
	{
		if ($this->GetY() > 570) {
			...
			$y += 6;
			$this->setXY(150, $y);
			$this->Write(10, utf8_encode('INFORMATION OF SURROUNDINGS AND FAMILY'));
		...
		$y += 6;
		$this->setXY(150, $y);
		$this->Write(10, utf8_encode('PEOPLE WHO COEXIST WITH THE CANDIDATE'));
		...
		$this->setXY($x, $y);
		$this->MultiCell(57, 20, utf8_encode('Parentage'), 0, 'L', false);
		$this->setXY(77, $y);
		$this->MultiCell(160, 20, utf8_encode('Name'), 0, 'C', false);
		$this->setXY(239, $y);
		$this->MultiCell(50, 20, utf8_encode('Age'), 0, 'C', false);
		$this->setXY(291, $y);
		/* $this->MultiCell(50, 20, utf8_encode('Edo Civil'), 0, 'C', false);
		$this->setXY(293, $y); */
		$this->MultiCell(110, 20, utf8_encode('Occupation'), 0, 'C', false);
		$this->setXY(403, $y);
		$this->MultiCell(110, 10, utf8_encode('Company / School'), 0, 'C', false);
		$this->setXY(515, $y);
		$this->MultiCell(87, 10, utf8_encode('¿Is it economic dependent?'), 0, 'C', false);
		/* $this->setXY(522, $y);
		...
		foreach ($cohabitantes as $cohabitante) {
			...
			$Parentesco = Utils::getParentescoIng($id_parentesco);
			$this->MultiCell(57, 8, utf8_encode($Parentesco), 0, 'L', false);
			$this->setXY(77, $y);
			$this->MultiCell(160, 8, utf8_encode($cohabitante['Nombre']), 0, 'C', false);
			$this->setXY(239, $y);
			$this->MultiCell(50, 8, utf8_encode($cohabitante['Edad'] . ' ' . ($cohabitante['Edad_2'] == 'Años' ? 'Age' : 'Months')), 0, 'C', false);
			...
			$this->setXY(293, $y); */
			$this->MultiCell(110, 8, utf8_encode($cohabitante['Edad_2'] == 'Años' && $cohabitante['Edad'] > 2 ? $cohabitante['Ocupacion'] : 'Does not apply'), 0, 'C', false);
			$this->setXY(403, $y);
			$this->MultiCell(110, 8, utf8_encode($cohabitante['Edad_2'] == 'Años' && $cohabitante['Edad'] > 2 ? $cohabitante['Empresa'] : 'Does not apply'), 0, 'C', false);
			$this->setXY(515, $y);
			$dependiente_economico = $cohabitante['Dependiente'] == 1 ? 'Yes, yes he/she does' : "No, he/she doesn't";
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(97, 15, utf8_encode('Comments'), 0, 'L');
	...
	public function setVivienda($vivienda, $ubicacion, $comentarios)
	{
		if ($vivienda && $ubicacion) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('ABOUT HOUSING'));
			...
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Time living at the domicile'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Street'), 0, 'L', false);
			...
			$this->setTextColor(0, 0, 0);
			$this->setXY(452, $y);
			$this->MultiCell(46, 15, utf8_encode('inner'), 0, 'C', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Colony'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY(310, $y);
			$this->MultiCell(62, 15, utf8_encode('Between:'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Delegation or municipality'), 0, 'L', false);
			...
			if ($_GET['candidato'] == 47740) {
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY(310, $y);
				$this->MultiCell(62, 15, utf8_encode('Country'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY(310, $y);
				$this->MultiCell(62, 15, utf8_encode('state'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY(452, $y);
			$this->MultiCell(46, 15, utf8_encode('Zip code'), 0, 'C', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 8, utf8_encode('Color and Facade Description:'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Housing type'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(158, $y);
			$Tipo_Vivienda = Utils::getTipoViviendaIng($vivienda->Tipo_Vivienda);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Number of plants or levels'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY(310, $y);
			$this->MultiCell(140, 15, utf8_encode('Number of bathrooms:'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Number of bedrooms'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY(310, $y);
			$this->MultiCell(140, 15, utf8_encode('Garage capacity'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('¿The place where it lives is?'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(158, $y);
			$Domicilio_es = Utils::getDomicilioEsIng($vivienda->Domicilio_es);
			...
			if ($vivienda->Domicilio_es != 160) {
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY($x, $y);
				$this->MultiCell(138, 8, utf8_encode("In case of not being the owner, name of the propietary"), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY($x, $y);
				$this->MultiCell(138, 15, utf8_encode('Parentage'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY(310, $y);
				$this->MultiCell(140, 15, utf8_encode('Cell phone'), 0, 'L', false);
			...
			if ($vivienda->Domicilio_es == 161) {
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY($x, $y);
				$this->MultiCell(138, 8, utf8_encode('In case of lease.Does the contract have?'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY(310, $y);
				$this->MultiCell(140, 15, utf8_encode('Contract time'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->setXY($x, $y);
			$this->MultiCell(138, 15, utf8_encode('Comments'), 0, 'L', false);
			...
			if ($ubicacion->Maps) {
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY($x, $y);
				$this->MultiCell(138, 15, utf8_encode('Geographic location'), 0, 'L', false);
	...
	{
		if (!$r_foto_exterior) {
			$r_foto_exterior = array('dist/img/Sin_picture.png', 'png');
		}
		...
		$y += 6;
		$this->setXY(210, $y);
		$this->Write(10, utf8_encode('PHOTO OF THE EXTERIOR OF THE HOUSE'));
	...
	public function setFotoNoExteriorDomicilio($r_foto_exterior)
	{
		if ($r_foto_exterior) {
			...
			$y += 6;
			$this->setXY(180, $y);
			$this->Write(10, utf8_encode('PHOTO OF THE DOMICILE NUMBER '));
	...
	{
		if (!$r_foto_interior) {
			$r_foto_interior = array('dist/img/Sin_picture.png', 'png');
		}
		...
		$y += 6;
		$this->setXY(220, $y);
		$this->Write(10, utf8_encode('PHOTO OF THE INTERIOR OF THE HOUSE'));
	...
	public function setFotoUbicacionGeografica($r_ubicacion_geografica)
	{
		if ($r_ubicacion_geografica) {
			...
			$y += 6;
			$this->setXY(170, $y);
			$this->Write(10, utf8_encode('GEOGRAPHIC LOCATION OF THE ADDRESS'));
	...
	public function setFotoUbicacionCalle($r_ubicacion_calle)
	{
		if ($r_ubicacion_calle) {
			...
			$y += 6;
			$this->setXY(170, $y);
			$this->Write(10, utf8_encode('HOME STREET LOCATION'));
	...
	public function setReferencias($referencias)
	{
		if ($referencias) {
			...
			foreach ($referencias as $key => $referencia) {
				...
				$this->SetFillColor(255, 255, 255);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Type reference'), 0, 'L', false);

				$this->setFont('SinkinSans', '', 6.5);
				$this->setTextColor(0, 0, 0);
				$this->setXY(250, $y);
				$this->MultiCell(350, 18, utf8_encode(Utils::getTipoReferenciaIng($referencia['Tipo'])), 0, 'L', true);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Relationship with the candidate'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Name'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Cell phone'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Address of the reference'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode("¿What is the candidate's address?"), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode("¿How long has the candidate been living there?"), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode("¿How long have you known the candidate?"), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode("¿Do you know if the candidate has children?"), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('¿Do you know what the candidate does for a living?'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('¿Do you know about their marital status?'), 0, 'L', false);
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(223, 10, utf8_encode('Comments about the candidate'), 0, 'L', false);
	...
	public function setEconomiaFamiliar($ingresos, $egresos, $comentarios)
	{
		...
		$y += 6;
		$this->setXY(240, $y);
		$this->Write(10, utf8_encode('FAMILY ECONOMY'));
		...
		$this->setXY($x, $y);
		$this->MultiCell(117, 15, utf8_encode('¿Who contributes?'), 0, 'C', false);
		$this->setXY(129, $y);
		$this->MultiCell(117, 15, utf8_encode('Source of income'), 0, 'C', false);
		$this->setXY(248, $y);
		$this->MultiCell(117, 15, utf8_encode('Monthly amount'), 0, 'C', false);
		$this->setXY(372, $y);
		$this->MultiCell(112, 15, utf8_encode('Discharge'), 0, 'L', false);
		$this->setXY(486, $y);
		$this->MultiCell(114, 15, utf8_encode('Monthly amount'), 0, 'R', false);
		...
		foreach ($egresos as $key => $egreso) {
			if ($egreso['Monto'] <> 0) {
				...
				$this->setTextColor(140, 140, 140);
				$this->setXY(372, $y2);
				$this->MultiCell(112, 16, utf8_encode(Utils::getEconomiaFamiliarIng($egreso['Descripcion'])), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->setXY($x, $y);
		$this->MultiCell(103, 15, utf8_encode('MONTHLY TOTAL'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->setXY(372, $y);
		$this->MultiCell(112, 15, utf8_encode('MONTHLY TOTAL'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->setXY($x, $y);
		$this->MultiCell(103, 15, utf8_encode('DIFFERENCE'), 0, 'L', false);
	...
	public function setInformacionFinanciera($creditos, $cuentas, $seguros, $INFONAVIT)
	{
		if ($creditos || $cuentas || $seguros || $INFONAVIT) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('FINANCIAL INFORMATION'));
		...
		if ($INFONAVIT) {
			...
			$this->SetFillColor(255, 255, 255);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿The candidate has credit INFONAVIT?'), 0, 'L', false);
		...
		if (count($creditos) > 0) {
			...
			$this->setTextColor(255, 255, 255);
			$this->MultiCell(592, 15, utf8_encode('CONSUMER LOANS OR TDC'), 0, 'C', true);
			...
			$this->setXY($x, $y);
			$this->MultiCell(115, 15, utf8_encode('Institution'), 0, 'C', false);
			$this->setXY(129, $y);
			$this->MultiCell(117, 15, utf8_encode('Credit limit'), 0, 'C', false);
			$this->setXY(248, $y);
			$this->MultiCell(117, 15, utf8_encode('Current balance approximation'), 0, 'C', false);
			$this->setXY(372, $y);
			$this->MultiCell(112, 15, utf8_encode('Expiration'), 0, 'C', false);
			$this->setXY(486, $y);
			$this->MultiCell(114, 15, utf8_encode('Monthly payment'), 0, 'C', false);
	...
	public function setInformacionPatrimonial($inmuebles, $vehiculos)
	{
		if ($inmuebles || $vehiculos) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('PATRIMONIAL INFORMATION'));
		...
		if (count($inmuebles) > 0) {
			...
			$this->SetFillColor(140, 140, 140);
			$this->setTextColor(255, 255, 255);
			$this->MultiCell(592, 15, utf8_encode('PROPERTY'), 0, 'C', true);
			...
			$this->setXY($x, $y);
			$this->MultiCell(115, 15, utf8_encode('type'), 0, 'C', false);
			$this->setXY(129, $y);
			$this->MultiCell(117, 15, utf8_encode('location'), 0, 'C', false);
			$this->setXY(248, $y);
			$this->MultiCell(117, 15, utf8_encode('valor'), 0, 'C', false);
			$this->setXY(372, $y);
			$this->MultiCell(112, 15, utf8_encode('paid'), 0, 'C', false);
			$this->setXY(486, $y);
			$this->MultiCell(114, 15, utf8_encode('Monthly payment'), 0, 'C', false);
		...
		if (count($vehiculos) > 0) {
			...
			$this->SetFillColor(140, 140, 140);
			$this->setTextColor(255, 255, 255);
			$this->MultiCell(592, 15, utf8_encode('VEHICLES'), 0, 'C', true);
			...
			$this->setXY($x, $y);
			$this->MultiCell(115, 15, utf8_encode('Brand'), 0, 'C', false);
			$this->setXY(129, $y);
			$this->MultiCell(117, 15, utf8_encode('Model'), 0, 'C', false);
			$this->setXY(248, $y);
			$this->MultiCell(117, 15, utf8_encode('valor'), 0, 'C', false);
			$this->setXY(372, $y);
			$this->MultiCell(112, 15, utf8_encode('Paid'), 0, 'C', false);
	...
	public function setConclusiones($observaciones)
	{
		...
		$this->SetFillColor(255, 255, 255);
		$this->SetXY($x, $y);
		$this->MultiCell(100, 9, utf8_encode('Regarding the candidate'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(100, 8, utf8_encode('About their family and surroundings'), 0, 'L', false);
		...
		$this->setTextColor(140, 140, 140);
		$this->SetXY($x, $y);
		$this->MultiCell(100, 8, utf8_encode("Interviewer's conclusions"), 0, 'L', false);
		...
		$this->SetXY(158, $y);
		$this->MultiCell(148, 18, utf8_encode('Good'), 0, 'C', true);
		$this->SetXY(306, $y);
		$this->MultiCell(148, 18, utf8_encode('Regular'), 0, 'C', true);
		$this->SetXY(454, $y);
		$this->MultiCell(148, 18, utf8_encode('No acceptable'), 0, 'C', true);

		$y = $this->GetY();

		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode("Candidate's participation"), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		...
		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode('Family environment'), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		$this->Circle(232, $y + 7, 6, 'F');
		$this->Circle(380, $y + 7, 6, 'F');
		$this->Circle(528, $y + 7, 6, 'F');
		...
		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode('Personal references'), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		$this->Circle(232, $y + 7, 6, 'F');
		$this->Circle(380, $y + 7, 6, 'F');
		$this->Circle(528, $y + 7, 6, 'F');
		...
		$y += 6;
		$this->setXY(140, $y);
		$this->Write(10, utf8_encode('GENERAL COMMENTS ON THE VERIFICATION'));
	...
	public function setInvestigacionLaboral($investigacion, $Empresa, $sexo)
	{
		$sexo = $sexo == 98 ? 'he' : 'she';
		if ($investigacion) {
			if ($this->GetY() >= 400) {
			...
			$y += 6;
			$this->setXY(227, $y);
			$this->Write(10, utf8_encode('LABOR RESEARCH'));
			...
			$this->SetFillColor(255, 255, 255);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿Does de candidate has work records??'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(308, $y);
			$this->MultiCell(292, 18, utf8_encode($investigacion->Circunstancias_Laborales == 'Si' ? 'Yes,'.$sexo.' does' : "No,$sexo doesn't"), 0, 'L', true);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿Provided the contact data of its jobs?'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(308, $y);
			$this->MultiCell(292, 18, utf8_encode($investigacion->Proporciono_Datos_Empleos == 'Si' ? 'Yes,'.$sexo.' does'  : "No,$sexo doesn't"), 0, 'L', true);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 8, utf8_encode('if not ¿what was the reason why did no provide them?'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿Has sued a company?'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6.5);
			$this->setTextColor(0, 0, 0);
			$this->setXY(308, $y);
			$this->MultiCell(292, 18, utf8_encode($investigacion->Demanda_Laboral == 'Si' ? 'Yes,'.$sexo.' does'  : "No,$sexo doesn't"), 0, 'L', true);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿If so, what was the reason?'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(281, 18, utf8_encode('¿Number of jobs recorded in the last 3 years?'), 0, 'L', false);
			...
			if (($investigacion->Sindicalizado == 1 || $investigacion->Sindicalizado == '0') && $Empresa == 190) {
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(200, 12, utf8_encode('¿In the companies in which you have worked, have you been as unionized personnel?'), 0, 'L', true);
				...
				$this->SetXY(229, $y - 8);
				$this->MultiCell(77, 27, utf8_encode('Yes               No'), 0, 'C', false);


				$this->SetFillColor(255, 255, 255);
				if ($investigacion->Sindicalizado == 1) {
					$this->SetXY(321, $y);
					$this->MultiCell(103, 12, utf8_encode('¿In which?'), 0, 'L', false);
					...
					$this->setTextColor(140, 140, 140);
					$this->SetXY($x, $y);
					$this->MultiCell(200, 14, utf8_encode('Work in the trade union committee'), 0, 'L', true);
					...
					if ($investigacion->Comite_Sindical == 1) {
						$this->SetXY(321, $y);
						$this->MultiCell(103, 27, utf8_encode('¿What was the position?'), 0, 'L', false);
						...
						$this->setTextColor(140, 140, 140);
						$this->SetXY($x, $y);
						$this->MultiCell(103, 10, utf8_encode('¿What were their functions?'), 0, 'L', false);
						...
						$this->setTextColor(140, 140, 140);
						$this->SetXY(321, $y);
						$this->MultiCell(103, 10, utf8_encode('¿During how much time?'), 0, 'L', false);
	...
	public function setReferenciasLaborales($referencias_laborales, $Cliente, $Empresa)
	{
		foreach ($referencias_laborales as $key => $referencia) {
			...
			$y += 6;
			$this->setXY(230, $y);
			$this->Write(10, 'WORK REFERENCE ' . ($key + 1));
			...
			$this->SetFillColor(255, 255, 255);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Company'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 18, utf8_encode('Activity'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Residence'), 0, 'L', false);

			$this->setFont('SinkinSans', '', 6);
			$this->setTextColor(0, 0, 0);
			$this->setXY(130, $y);
			$this->MultiCell(176, 9, utf8_encode($referencia['Domicilio']), 0, 'L', true);

			$this->setFont('SinkinSans', 'B', 6.5);
			$this->setTextColor(140, 140, 140);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 18, utf8_encode('Telephone'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Date of admission'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 18, utf8_encode('Discharge date'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Initial position'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 18, utf8_encode('Final position'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Immediate boss'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 18, utf8_encode('Boss postition'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 27, utf8_encode('Reason for separation'), 0, 'L', false);
			...
			if ($Cliente == 314) {
				...
				$this->setTextColor(140, 140, 140);
				$this->SetXY($x, $y);
				$this->MultiCell(300, 14, utf8_encode('¿Do you know if you can consume aspassed the controlled drugs?'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(200, 14, utf8_encode('¿Is the candidate a rehireable person?'), 0, 'L', true);
			...
			$this->SetFillColor(255, 255, 255);
			$this->SetXY(321, $y);
			$this->MultiCell(103, 27, utf8_encode('Why?'), 0, 'L', false);
			...
			if (($referencia['Sindicalizado'] == 1 || $referencia['Sindicalizado'] == '0') && $Empresa == 190) {
				...
				if ($referencia['Sindicalizado'] == 1) {
					$this->SetXY(321, $y);
					$this->MultiCell(103, 12, utf8_encode('¿En cuál sindicato permanecio?'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 9, utf8_encode('Name and position of who provides the information'), 0, 'L', false);
			...
			$this->setTextColor(140, 140, 140);
			$this->SetXY($x, $y);
			$this->MultiCell(103, 18, utf8_encode('Comments'), 0, 'L', false);
			...
			if ($referencia['Calif'] == 0) {
				...
				$this->MultiCell(148, 18, '', 0, 'L', true);
				$this->SetXY(158, $y);
				$this->MultiCell(111, 18, utf8_encode('Great'), 0, 'C', true);
				$this->SetXY(269, $y);
				$this->MultiCell(111, 18, utf8_encode('Appropriate'), 0, 'C', true);
				$this->SetXY(380, $y);
				$this->MultiCell(111, 18, utf8_encode('Regular'), 0, 'C', true);
				$this->SetXY(491, $y);
				$this->MultiCell(111, 18, utf8_encode('Bad'), 0, 'C', true);

				$y = $this->GetY();

				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Job performance'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				...
				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Honesty'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				$this->Circle(213, $y + 7, 6, 'F');
				$this->Circle(324, $y + 7, 6, 'F');
				$this->Circle(435, $y + 7, 6, 'F');
				...
				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Assistance and punctuality'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				$this->Circle(213, $y + 7, 6, 'F');
				$this->Circle(324, $y + 7, 6, 'F');
				$this->Circle(435, $y + 7, 6, 'F');
				...
				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Relationship with superiors and colleagues'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				$this->Circle(213, $y + 7, 6, 'F');
				$this->Circle(324, $y + 7, 6, 'F');
				$this->Circle(435, $y + 7, 6, 'F');
				...
				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Responsibility'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				$this->Circle(213, $y + 7, 6, 'F');
				$this->Circle(324, $y + 7, 6, 'F');
				$this->Circle(435, $y + 7, 6, 'F');
				...
				$this->SetXY(10, $y);
				$this->MultiCell(591, 16, utf8_encode('Adaptation to the work environment'), 0, 'L', true);
				$this->SetFillColor(255, 255, 255);
				$this->Circle(213, $y + 7, 6, 'F');
				$this->Circle(324, $y + 7, 6, 'F');
				$this->Circle(435, $y + 7, 6, 'F');
				...
				$y = $this->GetY() + 25;
				$this->SetXY(130, $y);
				$this->MultiCell(0, 18, utf8_encode("The company did not provide candidate's performance data."), 0, 'L', true);
			}
		}
	}
	...
	public function setResultadoInvestigacionLaboral($observaciones, $Empresa)
	{
		...
		$y += 6;
		$this->setXY(150, $y);
		$this->Write(10, utf8_encode('RESULT OF LABOR RESEARCH'));
		...
		$this->MultiCell(148, 18, '', 0, 'L', true);
		$this->SetXY(158, $y);
		$this->MultiCell(148, 18, utf8_encode('Well'), 0, 'C', true);
		$this->SetXY(306, $y);
		$this->MultiCell(148, 18, utf8_encode('Regular'), 0, 'C', true);
		$this->SetXY(454, $y);
		$this->MultiCell(148, 18, utf8_encode('Bad'), 0, 'C', true);

		$y = $this->GetY();

		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode('Information provided by the candidate '), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		$this->Circle(232, $y + 7, 6, 'F');
		$this->Circle(380, $y + 7, 6, 'F');
		$this->Circle(528, $y + 7, 6, 'F');
		...
		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode('Labor references obtained'), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		$this->Circle(232, $y + 7, 6, 'F');
		$this->Circle(380, $y + 7, 6, 'F');
		$this->Circle(528, $y + 7, 6, 'F');
		...
		$this->SetXY(10, $y);
		$this->MultiCell(591, 16, utf8_encode('Reliable and verifiable information'), 0, 'L', true);
		$this->SetFillColor(255, 255, 255);
		$this->Circle(232, $y + 7, 6, 'F');
		$this->Circle(380, $y + 7, 6, 'F');
		$this->Circle(528, $y + 7, 6, 'F');
	...
	public function setNotasLegales($ral)
	{
		if ($ral->Comentarios) {
			...
			$y += 6;
			$this->setXY(250, $y);
			$this->Write(10, utf8_encode('LEGAL NOTES'));
	...
	public function setFotoCredencial($r_foto_credencial_frente, $r_foto_credencial_atras)
	{
		if ($r_foto_credencial_frente) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('VOTING LISENSE (ID)'));
	...
	public function setFotoActaNacimiento($r_foto_acta)
	{
		if ($r_foto_acta) {
			...
			$y += 6;
			$this->setXY(230, $y);
			$this->Write(10, utf8_encode('BIRTH CERTIFICATE'));
	...
	public function setFotoLicenciaConducir($r_foto_licencia)
	{
		if ($r_foto_licencia) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode("DRIVER'S LICENSE"));
	...
	public function setFotoCartillaMilitar($r_foto_cartilla_militar)
	{
		if ($r_foto_cartilla_militar) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('MILITARY CARD'));
	...
	public function setFotoNSS($r_foto_nss)
	{
		if ($r_foto_nss) {
			...
			$y += 6;
			$this->setXY(210, $y);
			$this->Write(10, utf8_encode('SOCIAL SECURITY NUMBER'));
	...
	public function setFotoComprobanteDomicilio($r_foto_comprobante_domicilio)
	{
		if ($r_foto_comprobante_domicilio) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('PROOF OF ADDRESS'));
	...
	public function setFotoComprobanteEstudios($r_foto_comprobante_estudios)
	{
		if ($r_foto_comprobante_estudios) {
			...
			$y += 6;
			$this->setXY(230, $y);
			$this->Write(10, utf8_encode('PROOF OF STUDIES'));
	...
	public function setFotoRegistroPatronal($r_foto_registro_patronal, $i)
	{
		if ($r_foto_registro_patronal) {
			...
			$y += 6;
			$this->setXY(230, $y);
			$this->Write(10, utf8_encode('EMPLOYER REGISTRATION ' . $i));
	...
	public function setFotoRedesSociales($r_foto_redes_sociales, $comentario)
	{
		if ($r_foto_redes_sociales) {
			...
			$y += 6;
			$this->setXY(250, $y);
			$this->Write(10, utf8_encode('SOCIAL NETWORKS'));
	...
	public function setFotoCartaLaboral($r_foto_carta_laboral, $i)
	{
		if ($r_foto_carta_laboral) {
			...
			$y += 6;
			$this->setXY(250, $y);
			$this->Write(10, utf8_encode('WORKING LETTER ' . $i));
	...
	public function setFotoCartaLiberacionInfonavit($r_foto_infonavit)
	{
		if ($r_foto_infonavit) {
			...
			$y += 6;
			$this->setXY(180, $y);
			$this->Write(10, utf8_encode('LIBERATION LETTER INFONAVIT'));
	...
	public function setFotoCartaInfonavitNo($r_foto_infonavit)
	{
		if ($r_foto_infonavit) {
			...
			$y += 6;
			$this->setXY(180, $y);
			$this->Write(10, utf8_encode('PROOF OF INFONAVIT (No)'));
	...
	public function setFotoContratoArrendamiento($r_foto_contrato_arrendamiento)
	{
		if ($r_foto_contrato_arrendamiento) {
			...
			$y += 6;
			$this->setXY(180, $y);
			$this->Write(10, utf8_encode('LEASING CONTRACT'));
	...
	public function setFotoAvisoPrivacidad($r_foto_aviso_privacidad)
	{
		if ($r_foto_aviso_privacidad) {
			...
			$y += 6;
			$this->setXY(160, $y);
			$this->Write(10, utf8_encode('NOTICE OF PRIVACY'));
	...
	public function setFotoCartaVD($r_foto_carta_vd)
	{
		if ($r_foto_carta_vd) {
			...
			$y += 6;
			$this->setXY(160, $y);
			$this->Write(10, utf8_encode('Home visit letter'));
	...
	public function setFotoBuroCredito($r_foto_buro_credito)
	{
		if ($r_foto_buro_credito) {
			...
			$y += 6;
			$this->setXY(200, $y);
			$this->Write(10, utf8_encode('CREDIT BUREAU'));
	...
	public function setFotoExteriorDomicilioGestor($r_foto_foto_exterior_gestor)
	{
		if ($r_foto_foto_exterior_gestor) {
			...
			$y += 6;
			$this->setXY(105, $y);
			$this->Write(10, utf8_encode('Photo from the outside of the address (face -to -face visit)'));
	...
	public function setFotoCandidatoGestor($r_foto_candidato_gestor)
	{
		if ($r_foto_candidato_gestor) {
			...
			$y += 6;
			$this->setXY(220, $y);
			$this->Write(10, utf8_encode('Photo with the manager'));
	...
	function header()
	{
		if ($this->tieneHeader) {
			if ($this->seccionHeader == 1) {
				...
				$y += 6;
				$this->setXY(30, $y);
				$this->Write(10, utf8_encode('CANDIDATE INFORMATION'));
				...
				$y += 6;
				$this->setXY(20, $y);
				$this->Write(8, utf8_encode('INFORMATION ABOUT THE ENVIRONMENT AND FAMILY'));
				...
				$y += 6;
				$this->setXY(20, $y);
				$this->Write(10, utf8_encode('INFORMATION OF THE ECONOMY AND FAMILY ASSETS'));
				...
				$y += 6;
				$this->setXY(20, $y);
				$this->Write(10, utf8_encode('DOCUMENTARY EVIDENCE'));
			} else {
