        ...
        <div class="modal-content" style="width:900px!important;margin-left:-150px">
            ...
            <form id="candidate-form">
                <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name" maxlength="100" value="">
                                </div>

                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="col-form-label">Apellido Paterno*</label>
                                        <input type="text" class="form-control" name="surname" id="surname" maxlength="100" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="last_name" id="last_name" maxlength="100" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label f class="col-form-label">Fecha de
                                            nacimiento</label>
                                        <input type="date" name="date_birth" id="date_birth" class="form-control" value="">
                                    </div>
                                </div>
                                <!-- gabo 18 abril vacante -->
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="age" id="age" class="form-control" value="" min="16" max="99">
                                    </div>
                                </div>
                                <!-- gabo 18 abril vacante -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Este campo no es obligatorio, escribe la reseña cuando se termine de entrevistar al candidato." name="description" id="description" rows="10" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telephone" id="telephone" maxlength="13" class="form-control" value="<?= isset($candidato) && is_object($candidato) ? $candidato->telephone : ''; ?>" data-inputmask='"mask": "999 999 9999"' data-mask>
                                    </div>
                                </div>
                                <!-- ===[gabo 1 agosto operativa]== -->
                                <div class="col-md-4" id="div-celular">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cellphone" id="cellphone" maxlength="13" class="form-control" value="" data-inputmask='"mask": "999 999  9999"' data-mask>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="comment" name="comment" rows="5" cols="30"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" id="id_candidate_directory" name="id_candidate_directory" value="">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="text-align:center">
                                    <button class="btn btn-lg btn-success float-left " type="submit" value="0" hidden name="create" id="create">Guardar en
                                        bolsa</button>
                                </div>

                                <div class="col-md-3" style="text-align:center">
                                    <button class="btn btn-lg btn-orange float-right " type="submit" value="0" hidden name="postulate" id="postulate">Postular
                                    </button>
                                </div>


                                <div class="col-md-3">
                                    <button class="btn btn-lg btn-primary float-right ml-1" type="sumbit" id="directory" name="directory">
                                        Guardar </button>

                                    <a class="btn btn-lg btn-success float-right ml-1" id="ver" name="ver" hidden target="_blank">
                                        Ver </a>
                                </div>
                            </div>
                        </div>
