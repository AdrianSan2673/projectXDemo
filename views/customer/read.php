                ...
                <div class="row">
                    <div class="col-sm-2 mr-auto">
                        <a class="btn btn-secondary btn-block float-left"
                            href="<?= base_url ?>cliente/index">Regresar</a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-md-12">
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="<?= base_url ?>cliente/editar&id=<?= $_GET['id'] ?>"
                        ...
                        <div class="card card-orange">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    <a href="<?= base_url ?>clientecontacto/crear&id=<?= $_GET['id'] ?>"
                                        class="btn btn-success">Crear contacto</a>
                                    <a class="btn btn-warning btn-modal-crear" hidden id="btn_contacto_modal"
                                        data-id="<?= $_GET['id'] ?>">Crear contacto modal</a>
                                </div>
                                <?php endif ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <!-- gabo 2 sept -->
                                                    <button class="btn btn-warning" data-id="<?= $c['username'] ?>"
                                                        data-nombre="<?= $c['first_name'] . " " . $c['last_name'] ?>">
                                                        <i class="fas fa-envelope"></i>
                                                    </button>
                                                    <!-- gabo 2 sept -->
                                                    <!--  ////////////////////////////////// INICIO GABO  /////////////////////////////////   -->
                                                    <button class="btn btn-info btn-modal"
                                                        data-id="<?= Encryption::encode($c['id']) ?>">
                                            ...
                                            <td class="text-center  align-middle">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-info"
                                                        data-id="<?= Encryption::encode($CustomerContacts['id']) ?>">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </button>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                <div class="text-right">
                                    <a href="<?= base_url ?>businessname/crear&id=<?= $_GET['id'] ?>"
                                        class="btn btn-success">Crear razón social</a>
                                </div>
                                <?php endif ?>
                                <table id="tb_bn" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                            <td class="text-center py-0 align-middle">
                                                <a href="<?= base_url ?>businessname/editar&id=<?= Encryption::encode($bn['id']) ?>"
                                                    class="btn btn-info">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col text-center">
                                        ...
                                        <p><?= $cliente->box_cut == 1 ? 'Contraentrega' : ($cliente->box_cut == 2 ? 'Semanal' : ($cliente->box_cut == 3 ? 'Quincenal' : ($cliente->box_cut == 4 ? 'Mensual' : ''))) ?>
                                        </p>
                                    </div>
                                </div>
                                <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                <div class="text-center">
                                    <a href="<?= base_url ?>cliente/condiciones&id=<?= $_GET['id'] ?>"
                                        class="btn btn-info">Editar</a>
                                </div>
                                <?php endif ?>
                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                <div class="text-right">
                                    <a href="<?= base_url ?>cliente/evaluar&id=<?= $_GET['id'] ?>"
                                        class="btn btn-success">Nueva evaluación</a>
                                </div>
                                <?php endif ?>
...
document.addEventListener('DOMContentLoaded', e => { //gabo 24
    ...
    document.querySelector('#tb_contacts').addEventListener('click', e => {
        ...
        if (e.target.classList.contains('btn-modal') || e.target.offsetParent.classList.contains(
                'btn-modal')) {
            let ID;
