                      ...
                      <div class="form-group row">
                        ...
                        <select name="id_cost_center" id="id_cost_center" class="form-control col-md-10">
                          ...
                          <?php foreach ($cost_centers as $center): ?>
                            <option value="<?=$center['id']?>" <?=isset($cliente) && is_object($cliente) && $center['id'] == $cliente->id_cost_center ? 'selected' : (isset($prospecto) && is_object($prospecto) && $prospecto->Plaza == $center['cost_center'] ? 'selected' : ''); ?>><?=$center['cost_center']?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
