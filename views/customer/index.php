                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                ...
                                <!-- ===[gabo 7 agosto creado por ]=== -->
                                <th class="text-center align-middle">Creado por</th>
                                <!-- ===[gabo 7 agosto creado por fin=== -->
                            <?php endif ?>
                            <th>Acciones</th>
                        </tr>
                            ...
                            <tr>
                                ...
                                <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()) : ?>
                                    ...
                                    <td class="text-center align-middle">
                                        <?= $last_evaluation = $customer['last_evaluation'] != NULL ? Utils::getShortDate($customer['last_evaluation']) : '' ?>
                                    </td>
                                    <td class="text-center align-middle">
                                        <?= $score = $customer['score'] != NULL ? number_format($customer['score'], 1) : '' ?>
                                    </td>
                                    <!-- ===[gabo 7 agosto creado por ]=== -->
                                    <td class="text-center align-middle">
                                        <?= $score = $customer['created_by'] != NULL ? $customer['created_by'] : '' ?>
                                    </td>
                                    <!-- ===[gabo 7 agosto creado por fin=== -->
                                <?php endif ?>
