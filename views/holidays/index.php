            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        <table id="tb_employees" class="table table-responsive table-striped table-sm"
                            style="display: none;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle"><?= $employee['start_date'] ?>
                                    </td>
                    ...
                    <div class="tab-pane" id="tab_3">
                        <div class="table-responsive">
                            <table id="table3" class="table table-responsive table-striped table-sm"
                                style="display: none;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr>">
                                        ...
                                        <td class="text-center" id="td">
                                            ...
                                            <button data-id="" value="<?= $solicitud['id'] ?>"
                                                class="btn btn-success mt-1" id="btn-aceptar">
                                                <i class="fas fa-check"> Aceptar</i>
                                            </button>

                                            <button data-id="<?= $solicitud['id'] ?>" class="btn btn-danger mt-1"
                                                id="btn-denegar">
                                                <i class="fas fa-ban"> Denegar</i>
                                            </button>
                                            <!-- //GABO 20 OCT -->
                                            <button value="<?= $solicitud['id'] ?>" class="btn btn-warning mt-1"
                                                id="btn-borrar">
