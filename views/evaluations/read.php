              ...
              <div class="card">
                ...
                <div id="collapse_<?= $evaluacionCat['id'] ?>" class="collapse" data-parent="#accordion">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <button class="btn btn-orange creat_new_criterion" value="<?= Encryption::encode($evaluacionCat['id'])  ?>"> Crear nuevo criterio</button>
                      </div>
                    </div>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-4 ml-auto">
              <button class="btn btn-orange float-right" id="btn_new_operquestion">Agregar Pregunta abierta</button>
            </div>
          </div>
...
<script type="text/javascript">
  document.addEventListener('DOMContentLoaded', e => {
    ...
    document.querySelector('#btn_new_operquestion').addEventListener('click', e => {
      ...
      document.querySelectorAll('#modal_question_open input')[0].value = 1
    ...
    document.querySelector('#accordion').addEventListener('click', function(e) {
      ...
      if (e.target.classList.contains('btn_update_category') || e.target.offsetParent.classList.contains('btt_update_category')) {
      ...
      if (e.target.classList.contains('btn_new_category_criterion') || e.target.offsetParent.classList.contains('btn_new_category_criterion')) {
      ...
      if (e.target.classList.contains('creat_new_criterion') || e.target.offsetParent.classList.contains('creat_new_criterion')) {
        let id_category;
      ...
      //Eliminar  criterios 
      if (e.target.classList.contains('btn_delete_criterion') || e.target.parentNode.classList.contains('btn_delete_criterion')) {
      ...
      if (e.target.classList.contains('btn_new_question') || e.target.offsetParent.classList.contains('btn_new_question')) {
        let value;
      ...
      //Actualizar pregunta 
      if (e.target.classList.contains('btn_update_question') || e.target.offsetParent.classList.contains('btn_update_question')) {
        let id_question;
      ...
      //Eliminar  pregunta 
      if (e.target.classList.contains('btn_delete_question') || e.target.offsetParent.classList.contains('btn_delete_question')) {
        let id_question;
      ...
      if (e.target.classList.contains('btn_new_criterionScore') || e.target.offsetParent.classList.contains('btn_new_criterionScore')) {
        let value;
      ...
      if (e.target.classList.contains('btn_update_criterion_score') || e.target.offsetParent.classList.contains('btn_update_criterion_score')) {
      ...
      if (e.target.classList.contains('btn_delete_criterion_score') || e.target.offsetParent.classList.contains('btn_delete_criterion_score')) {
        let id_question;
