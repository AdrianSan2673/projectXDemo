                                                     ...
                                                     <div class="row">
                                                         <div class="col-md-11">
                                                             <a class="d-block w-100 collapsed" data-toggle="collapse" href="#collapse_<?= $evaluacionCat['id'] ?>" aria-expanded="true">
                                                                 ...
                                                                 <?php   if ($evaluation_employee->score != '') : $score_category = " " . $calificacion[$evaluacionCat['id']] . "%   de "; else:  $score_category = ''; endif; ?>
                                                             ...
                                                             <table class="table m-0">
                                                                 ...
                                                                 <tbody>
                                                                     ...
                                                                     <tr>
                                                                         <td><b>Total </b></td>
                                                                         <?php
                                                                            if ($total >= 99) :   $total = 100;  endif;
                                                                            
                                                                            if ($total >= 70) : ?>
                                                                             <td><b><span class="badge badge-success"> <?= $total . "%" ?> </span></b></td>
                                                                         <?php else : ?>
                                                                             <td><b><span class="badge badge-warning"> <?= $total . "%" ?> </span></b></td>
                                                                         <?php endif; ?>
                                                                         </td>
                                                                     </tr>
                                                                 </tbody>
