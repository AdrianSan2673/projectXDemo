  ...
  <section class="content-header">
    <div class="row">
      <div class="col-sm-2 ml-auto">
        <button class="btn btn-orange float-right" id="btn_new_evaluation">Crear Plantilla de evaluación</button>
      </div>
    </div>
  </section>
          ...
          <div class="small-box bg-info">
            ...
            <div class="inner">
              ...
              <div class="row">
                ...
                <div class="col-8">
                  <p style="font-size: small;">Actualizada en <?= substr(Utils::getDate($eva['modified_at']), 5) ?> </p>
                </div>
              </div>
            </div>
      ...
      if (e.target.classList.contains('btn-delete')) {
        Swal.fire({
          ...
          if (result.value == true) {
            evaluation.delet(e.target.value);
          }
        })
      }
