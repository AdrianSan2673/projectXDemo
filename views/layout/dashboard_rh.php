                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav nav-pills " id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="pill" href="#asistencias" role="tab" aria-controls="" aria-selected="true">Asistencias</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="pill" href="#solicitudes" role="tab" aria-controls="" aria-selected="false">Solicitud de
                                        vacaciones</a>
                                </li>
                                <?php if ($subordinados) : ?>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#div-pendientes" role="tab" aria-selected="false">Solicitudes Pendientes</a>
                                    </li>
                                <?php endif; ?>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="pill" href="#div-contrasena" role="tab" aria-selected="false">Contraseña</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="card-body">
                    <div class="tab-content" style="margin:-0.5rem">
                        ...
                        <div class="tab-pane fade show active" id="asistencias" role="tabpanel" aria-labelledby="">
                            ...
                            <input id="total_asistencias" type="" value="0">
                        ...
                        <div class="tab-pane fade" id="solicitudes" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="small-box <?= $holidays->holidays_by_year - $holidays->taken_holidays != 0 ? 'bg-primary' : 'bg-danger'  ?>     ">
                                        <div class="inner">
                            ...
                            <div style="padding-bottom:3rem">
                                ...
                                <div class="col-sm-2 ml-auto">
                                    <button class="btn btn-orange float-right" data-toggle="modal" id="btn_new_holidays" <?= ($holidays->holidays_by_year - $holidays->taken_holidays == 0) ? 'disabled' : ''; ?> data-target="#">Crear</button>
                                </div>
                                <!-- //gabo 6 sep -->
                            </div>
                            <div class="content" id="tabla-solicitudes">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabla2">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="width: 80px;max-width:80px;min-width:80px">#
                                                </th>
                                                <th class="text-center" style="width: 100;max-width:100px;min-width:10px">
                                                    Fecha de la
                                                    solicitud</th>
                                                <th class="text-center" style="width: 150;max-width:150px;min-width:150px">
                                                    Dias solicitados
                                                </th>
                                                <th class="text-center" style="width: 200px;max-width:200px;min-width:200px">Periodo de
                                                    Vacaciones</th>
                                                <th class="text-center" style="width: 200px;max-width:200px;min-width:200px">Comentarios
                                                </th>
                                                <th class="text-center" style="width: 150px;max-width:150px;min-width:150px">Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                ...
                                <div class="card" style="width:500px;margin:auto;" id="contra-div">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="id_user_h" value="<?= Encryption::encode($_SESSION['identity']->id) ?>" type="hidden" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="confirmacion" class="col-form-label">Confirma
                                                Contraseña:</label>
                                            <input name="confirmacion" type="text" id="confirmacion" class="form-control">
                                        </div>
                                    </div>
                                    <div class="modal-footer" style="display: flex;">

                                        <input type="submit" name="submit" id="sumbit-contrasena" class="btn btn-orange float-right" value="Guardar">
                                    </div>
                                </div>
                            </form>
                        </div>
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12" style="text-align:center;margin-top:-0.5rem;margin-bottom:1rem">
                                                                <?php if ($solicitud['status'] == 'En revisión') : ?>
                                                                    <button value="<?= Encryption::encode($solicitud['id']) ?>" class="btn btn-success mt-1" id="btn-aceptar">
                                                                        <i class="fas fa-check"> Aceptar</i>
                                                                    </button>
                                                                    <button data-id="<?= Encryption::encode($solicitud['id']) ?>" class="btn btn-danger mt-1" id="btn-denegar">
                                                                        <i class="fas fa-ban"> Declinar</i>
