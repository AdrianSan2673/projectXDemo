                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left mb-2">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="<?= base_url . 'empleado/index&flag=' . Encryption::encode(1) ?>">Empleados
                                </a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="surname" id="last_name" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last_name" id="surname" class="form-control"
                                                    maxlength="40" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="contract" class="col-form-label">Tipo de
                                                    contratacion*</label>
                                                <select class="form-control" name="contract" id="selectContract"
                                                    required>
                                                    <option disabled selected value="">Selecciona tipo de contrato
                                                    </option>
                                                    <option value="<?= Encryption::encode(1)  ?>">Periodo de prueba
                                                    </option>
                                                    <option value="<?= Encryption::encode(2)  ?>">Capacitación</option>
                                                    <option value="<?= Encryption::encode(3)  ?>">Contrato por obra
                                                    </option>
                                                    <option value="<?= Encryption::encode(4)  ?>">Tiempo determinado
                                                    </option>
                                                    <option value="<?= Encryption::encode(5)  ?>">Tiempo indeterminado
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="employee_number" minlength="0"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="scholarship" id="scholarship"
                                                    placeholder="Licenciatura" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="id_razon" id="select_razon_social"
                                                    required></select>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="ID_Contacto"
                                            value="<?= Encryption::encode($id_contacto)  ?>">
                                        <input type="hidden" name="Empresa"
                                            value="<?= Encryption::encode($Empresa)  ?>">
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" hidden id="new_position">
                                                ...
                                                <input type="text" name="new_position" id="new_position2"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" hidden id="deparment">
                                            <div class="form-group ">
                                                ...
                                                <select name="id_departament" id="departmentSelect"
                                                    class="form-control">
                                        ...
                                        <div class="col-md-6" id="new_deparment" hidden>
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="new_deparment" id="deparamentInput"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
