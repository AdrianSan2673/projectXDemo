        ...
        <div class="container-fluid">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-left mb-2">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="<?= base_url ?>Empleado/index&flag=<?= Encryption::encode($employee->status) ?>">Empleados</a>
                                </li>
                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center ml-5 mr-5 mb-3">
                                        ...
                                        <div class="btn-group btn-group-sm mt-2">
                                            ...
                                            <button class="btn btn-success btn-watch-photo"
                                                data-id=<?= $avatar->id ?>><i class="fas fa-eye"></i></button>
                                            <button class="btn btn-info btn-edit-photo" data-id="<?= $avatar->id ?>"><i
                                                    class="fas fa-pencil-alt mr-1"></i></button>
                                            <button class="btn btn-danger btn-delete-photo"
                                                data-id="<?= $avatar->id ?>"><i class="fas fa-times mr-1"></i></button>
                                            <?php endif ?>
                                            <label class="btn btn-orange ml-2">
                                                <input type="file" class="d-none btn-upload-photo"
                                                    accept="image/x-png,image/gif,image/jpeg"><i
                                    ...
                                    <div class="row">
                                        <div class="col-5 col-sm-3">
                                            <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab"
                                                ...
                                                <a class="nav-link active" id="vert-tabs-datos-generales-tab"
                                                    data-toggle="pill" href="#vert-tabs-datos-generales" role="tab"
                                                    aria-controls="vert-tabs-datos-generales"
                                                    aria-selected="false">Datos del empleado</a>
                                                <a class="nav-link" id="vert-tabs-historial-puestos-tab"
                                                    data-toggle="pill" href="#vert-tabs-historial-puestos" role="tab"
                                                    aria-controls="vert-tabs-historial-puestos"
                                                    aria-selected="false">Movimientos de personal</a>
                                                <a class="nav-link" id="vert-tabs-contratacion-tab" data-toggle="pill"
                                                    href="#vert-tabs-contratacion" role="tab"
                                                    aria-controls="vert-tabs-contratacion"
                                                    aria-selected="false">Historial de contratos</a>
                                                <a class="nav-link" id="vert-tabs-circulo-familiar-tab"
                                                    data-toggle="pill" href="#vert-tabs-circulo-familiar" role="tab"
                                                    aria-controls="vert-tabs-circulo-familiar"
                                                    aria-selected="false">Circulo familiar</a>
                                                <a class="nav-link" id="vert-tabs-nomina-tab" data-toggle="pill"
                                                    href="#vert-tabs-nomina" role="tab" aria-controls="vert-tabs-nomina"
                                                    aria-selected="false">Datos para Nomina</a>
                                                <a class="nav-link" id="vert-tabs-incidencias-tab" data-toggle="pill"
                                                    href="#vert-tabs-incidencias" role="tab"
                                                    aria-controls="vert-tabs-incidencias"
                                                    aria-selected="false">Incidencias</a>
                                                <a class="nav-link" id="vert-tabs-capacitacion-tab" data-toggle="pill"
                                                    href="#vert-tabs-capacitacion" role="tab"
                                                    aria-controls="vert-tabs-capacitacion"
                                                    aria-selected="false">Capacitacion</a>
                                                <a class="nav-link" id="vert-tabs-documentos-tab" data-toggle="pill"
                                                    href="#vert-tabs-documentos" role="tab"
                                                    aria-controls="vert-tabs-documentos"
                                                    aria-selected="false">Documentos</a>
                                                <a class="nav-link" id="vert-tabs-documentacion-tab" data-toggle="pill"
                                                    href="#vert-tabs-documentacion" role="tab"
                                                    aria-controls="vert-tabs-documentacion"
                                        ...
                                        <div class="col-7 col-sm-9">
                                            <div class="tab-content" id="vert-tabs-tabContent">
                                                ...
                                                <div class="tab-pane fade active show" id="vert-tabs-datos-generales"
                                                    role="tabpanel" aria-labelledby="vert-tabs-datos-generales-tab">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="card col-md-12 collapsed-card">
                                                            ...
                                                            <div class="card-body" style="display: block;">
                                                                <div id="content-datos-general">
                                                                    ...
                                                                    <div class="row divReasion"
                                                                        <?= isset($employee->end_date) ? '' : 'hidden' ?>>
                                                                        <div class="col-sm-4 text-center">
                                                                    ...
                                                                    <div class="row divRe_entrry_date"
                                                                        <?= isset($employee->re_entry_date) ? '' : 'hidden' ?>>
                                                                        <div class="col-sm-4 text-center">
                                                                ...
                                                                <div class="text-center">
                                                                    <button class="btn btn-info"
                                                                        id="btn-editar-empleado">Editar</button>
                                                                </div>
                                                                <?php endif ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card col-md-12 collapsed-card collapsed-card mt-3">
                                                            ...
                                                            <div class="card-body" style="display: none;">
                                                                ...
                                                                <div class="text-center">
                                                                    <button class="btn btn-info"
                                                                        id="btn-editar-contacto">Editar</button>
                                                                </div>
                                                                <?php endif ?>
                                                            </div>
                                                        ...
                                                        <div class="card collapsed-card col-md-12 mt-3">
                                                            ...
                                                            <div class="card-body" style="display: none;">
                                                                ...
                                                                <div class="text-center">
                                                                    <button class="btn btn-info"
                                                                        id="btn-editar-emergency">Editar</button>
                                                                </div>
                                                                <?php endif ?>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-historial-puestos"
                                                    role="tabpanel" aria-labelledby="vert-tabs-historial-puestos-tab">
                                                    <div class="row " hidden>
                                                        <div class="col-12 ">
                                                            <button class="btn btn-orange float-right"
                                                                id="btn-editar-puesto">Agregar puesto</a>
                                                        </div>
                                                    </div>

                                                    <table id="tb_history_positions"
                                                        ...
                                                        <tbody id="tboodyHistory">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class=" text-center ">
                                                                    <button class="btn btn-danger text-bold"
                                                                        value="<?= Encryption::encode($hp['id'])   ?>">X</button>
                                                                    <button class="btn btn-info"
                                                                        value="<?= Encryption::encode($hp['id'])    ?>"><i
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-contratacion" role="tabpanel"
                                                    aria-labelledby="vert-tabs-contratacion-tab">
                                                    <div id="datos_contrato">
                                                        <div class="row ">
                                                            <div class="col-12 ">
                                                                <button class="btn btn-orange float-right"
                                                                    id="btn-editar-contratos">Crear contrato</a>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <table id="tb_contract"
                                                                    ...
                                                                    <tbody id="tboodycontract">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class=" text-center ">
                                                                                <button class="btn btn-danger text-bold"
                                                                                    value="<?= Encryption::encode($emplContrac['id'])   ?>">X</button>
                                                                            </td>
                                                                        </tr>
                                                                        <?php endforeach; ?>
                                                                    </tbody>
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-circulo-familiar"
                                                    role="tabpanel" aria-labelledby="vert-tabs-circulo-familiar-tab">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <button class="btn btn-orange float-right"
                                                                id="btn-editar-familiar">Agregar familiar</a>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table id="tb_familly"
                                                                ...
                                                                <tbody id="tboodyFamily">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center align-middle">
                                                                            <button class="btn btn-danger text-bold"
                                                                                value="<?= Encryption::encode($empfam['id']) ?>">X</button>
                                                                            <button class="btn btn-info"
                                                                                value="<?= Encryption::encode($empfam['id']) ?>"><i
                                                                                    class="fas fa-edit"></i></button>
                                                                        </td>
                                                                    </tr>
                                                                    <?php endforeach;
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-nomina" role="tabpanel"
                                                    aria-labelledby="vert-tabs-nomina-tab">
                                                    <div id="divNomina">
                                                            ...
                                                            <table id="tb_employees_payroll"
                                                                ...
                                                                <tbody id="tableRollPay">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=" text-center ">
                                                                            <button class="btn btn-danger text-bold"
                                                                                value="<?= Encryption::encode($employeePayro['id'])   ?>">X</button>
                                                                        </td>
                                                                    </tr>
                                                                    <?php endforeach;
                                                                    ?>
                                                    ...
                                                    <div class="text-center ">
                                                        <button class="btn btn-info"
                                                            id="btn-editar-payroll">Editar</button>
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-incidencias" role="tabpanel"
                                                    aria-labelledby="vert-tabs-incidencias-tab">
                                                    <div class="row ">
                                                        <div class="col-12 ">
                                                            <button class="btn btn-orange float-right"
                                                                id="btn-editar-incidence">Agregar incidencia</a>
                                                        </div>
                                                    </div>
                                                    <!--   <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12" id="divTableIncidens">
                                                            <table id="tb_employees_incidens"
                                                                class="table table-responsive table-striped table-sm"
                                                                style="display: none;">
                                                                <thead>
                                                                    <tr>
                                                                ...
                                                                <tbody id="tboodyInciden">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center align-middle">
                                                                            <button class="btn btn-danger text-bold"
                                                                                value="<?= Encryption::encode($inc['id_incident'])  ?>">X</button>
                                                                        </td>
                                                                    </tr>
                                                                    <?php endforeach;
                                                                    ?>
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-capacitacion" role="tabpanel"
                                                    aria-labelledby="vert-tabs-capacitacion-tab">
                                                    <div class="row">
                                                        <div class="col-12 ">
                                                            <a href="<?= base_url  ?>capacitaciones/index"
                                                                class="btn btn-orange float-right">Ver
                                                                capacitaciones</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12" id="divTableTraining">
                                                            <table id="tb_employees_training"
                                                                class="table table-responsive table-striped table-sm"
                                                                style="display: none;">
                                                                <thead>
                                                                    <tr>
                                                                ...
                                                                <tbody id="tboodyTraining">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class=" align-middle ">
                                                                            <button class="btn btn-danger text-bold"
                                                                                value="<?= Encryption::encode($tra['id_employee_training']) . ',' . Encryption::encode($tra['id_employee'])  ?>">X</button>
                                                                        </td>
                                                                    </tr>
                                                                    <?php endforeach; ?>
                                                                </tbody>
                                                    ...
                                                    <div class="text-center " hidden>
                                                        <button class="btn btn-success"
                                                            id="btn-historial-capacitaciones">Ver historial de
                                                            capacitaciones</button>
                                                    </div>
                                                </div>

                                                <div class="tab-pane fade" id="vert-tabs-documentos" role="tabpanel"
                                                    aria-labelledby="vert-tabs-documentos-tab">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-8">
                                                                <label for="cv" class="col-form-label">Curriculum
                                                                    Vitae</label>
                                                                <input type="file" id="input_cv" class="form-control"
                                                                    name="cv" placeholder="Adjuntar currículum"
                                                    ...
                                                    <form action="" id="form_rfc">
                                                        <div class="row">
                                                            <div class="col-8">
                                                                ...
                                                                <input type="file" id="input_rfc" class="form-control"
                                                                    name="rfc" placeholder="Adjuntar RFC"
                                                                    class="form-control-file text-white"
                                                                    accept=" application/pdf">
                                                            </div>
                                                            <input type="hidden" name="id_employee"
                                                    ...
                                                    <form action="" id="form_cfdi">
                                                        <div class="row">
                                                            <div class="col-8">
                                                                ...
                                                                <input type="file" id="input_cfdi" class="form-control"
                                                                    name="cfdi" placeholder="Adjuntar CFDI"
                                                                    class="form-control-file text-white"
                                                                    accept=" application/pdf">
                                                            </div>
                                                            <input type="hidden" name="id_employee"
                                                ...
                                                <div class="tab-pane fade" id="vert-tabs-documentacion" role="tabpanel"
                                                    aria-labelledby="vert-tabs-documentacion-tab">
            ...
            <div class="row">
                <div class="col-sm-6 p-3">
                    <button class="btn btn-<?= $employee->status == 1 ? 'danger' : 'success' ?>"
                        id="btn-debaja-empleado" value="<?= $_GET['id']  ?>">Dar de
