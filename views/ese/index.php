<div class="content-wrapper">
    ...
    <?php endif ?>
    <?php if (Utils::isAdmin() || Utils::isSAManager() || Utils::isSenior() || Utils::isOperationsSupervisor() || Utils::isLogisticsSupervisor() || Utils::isManager() || Utils::isAccount()||$_SESSION['identity']->username == 'usuarioingenia' ): ?>
      <section class="content-header">
        <div class="row">
