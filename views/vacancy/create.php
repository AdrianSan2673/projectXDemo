        ...
        <div class="row mb-5">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left mb-2">
              ...
              <li class="breadcrumb-item active"><?= isset($_GET['id']) && !empty($vacante) ? $vacante->vacancy : 'Nueva vacante' ?></li>
            </ol>
          </div>
          <div class="col-sm-12">
          ...
          <div class="col-md-12">
            ...
            <form id="vacancy-form" method="POST">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="customer_contact" id="customer_contact" class="form-control" readonly>
                            <option readonly selected="selected" value="<?= $contacto->id ?>"><?= $contacto->first_name . ' ' . $contacto->last_name ?></option>
                          </select>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card card-info">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="<?= Utils::isSalesManager() || Utils::isSales() ? 'col-md-6'  : 'col-md-4' ?>"> <!-- gabo 17 abril quitar a ventas -->
                      <div class="form-group">
                        <label for="vacancy" class="col-form-label">Nombre del puesto</label>
                        <input type="text" name="vacancy" id="vacancy" maxlength="255" class="form-control"  style="<?= Utils::isAdmin() || Utils::isAdmin()  ? ''  : 'required' ?>" value="<?= isset($vacante) && is_object($vacante) ? $vacante->vacancy : ''; ?>"> <!-- gabo 17 abril quitar a ventas -->
                      </div>
                    </div>
                    <div class=" <?= Utils::isSalesManager() || Utils::isSales() ? 'col-md-6'  : 'col-md-4' ?>"><!-- gabo 17 abril quitar a ventas -->
              ...
              <div class="card card-maroon" hidden>
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="form-group col">
                      <label for="time_without_filling" class="col-form-label">¿Cuánto tiempo tiene sin cubrir esta vacante?</label>
                      <input type="text" name="time_without_filling" class="form-control">
                    </div>
                    <div class="form-group col">
                      <label for="another_agency" class="col-form-label">¿Están trabajando con alguna otra agencia de reclutamiento?</label>
