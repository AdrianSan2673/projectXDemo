            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <div class="alert alert-success">
                        <h3>Candidatos selectos para el puesto de <b><?= $vacante->vacancy ?>
                                <?= (Utils::isAdmin() || Utils::isRecruitmentManager()) ? 'Folio: #' . Encryption::decode($_GET['id']) : '' ?></b>
                        </h3>
                    </div>
...
function abrir_experiencia(id_candidate, nombre) {
  ...
  <div class="row borrados" style="margin-bottom:0.6rem; border:1px solid #98AE98 ; border-radius:15px;padding:1rem">
    ...
    <label class="col-form-label">Fecha Inicio:</label>
      <input type="date" name="start_date[]"  style="text-align:center;margin-bottom:0.5rem" value="" required class=" form-control" > 
    ...
    <label class="col-form-label">Fecha Fin:</label>
      <input type="date" name="end_date[]"  style="text-align:center;margin-bottom:0.5rem;width:70%" value="" required class=" form-control" > 
