                ...
                <div class="card card-orange">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group" style="text-align: center">
                          <label class="col-form-label">Requerido</label>
                          <input type="number" name="experience_years" id="experience_years" style="text-align:center"" class=" form-control" value="" readonly>
                        </div>
                      </div>
                  ...
                  <?php if ($vacante->type == 1) :   ?>
                    <div class="form-group" style="text-align: center; float:right">
                      <btn class="btn btn-success" onclick="agregarFila()">
                    ...
                    <div class="card-body" id="div_experience">
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div class="form-group" style="text-align: center">
                            <label for="" class="col-form-label" style="margin-top:30px">Descripcion:</label>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group" style="text-align: center">
                        ...
                        <div class="col-md-5">
                          <div class="form-group" style="text-align: center">
                            ...
                            <input type="text" name=position_experience[]" id=position_experience" style="text-align:center""  class=" form-control" value="" <?= Utils::isCustomer() ? 'disabled' : '' ?>>
                          </div>
                        </div>
                        <div class="col-md-1">
                          <div class="form-group" style="text-align: center">
    ...
    if (document.getElementById('div_experience')) {
      ...
      row.innerHTML = `
                          ...
                          <div class="col-md-5">
                            <div class="form-group" style="text-align: center">
                             <label class="col-form-label"></label>
                              <input type="text" name="position_experience[]"  style="text-align:center"  class=" form-control">
                            </div>
                          </div>
                          <div class="col-md-1">
