              ...
              <table id="tb_vacancies" class="table table-bordered table-striped" style="font-size: 0.6rem;">
                ...
                <?php foreach($orders as $order): ?>
                    <tr>
                        ...
                        <td><?=$order['city'].', '.$order['abbreviation']?></td>
                        ...
                        <td class="text-center align-middle"><?=$order['folio']?></td>
                ...
                <tbody>
                  <?php foreach($psychometrics as $psycho): ?>
                      <tr>
                          ...
                          ?>
                          <td class="text-center align-middle"><?=$psycho['id']?></td>
                          ...
                          <td class="text-center align-middle"><?=$psycho['cost_center']?></td>
                          <td class="text-center align-middle"><?=$psycho['folio']?></td>
