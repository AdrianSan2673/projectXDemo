              ...
              <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row info-empresa">
							...
							<div class="col-md-12 text-center">
                                ...
                                <p><?= $empresa->Especificaciones ? $empresa->Especificaciones : 'SIN ESPECIFICACIONES' ?></p>
                            </div>
                        </div>
                ...
                <div class="card card-orange">
                    ...
                    <div class="card-body">
                        <?php if (Utils::isAdmin() || Utils::isManager() || Utils::isSales() || Utils::isSalesManager() || Utils::isSenior()): ?>
                            <div class="text-right">
                                <a href="<?=base_url?>cliente_SA/crear&empresa=<?=$_GET['id']?>" class="btn btn-success">Crear cliente</a>
                            </div>
                        <?php endif ?>
                        <div class="table-responsive">
...
<script type="text/javascript">
    document.querySelector('#btn-editar-empresa').addEventListener('click', e => {
        ...
        $('#modal_empresa').modal({backdrop: 'static', keyboard: false});
    })
