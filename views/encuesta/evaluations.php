              ...
              <table id="tb_customers" class="table table-striped">
                <thead>
                    <tr>
                      ...
                      <th class="align-middle text-center">¿Nuestro servicio te ayuda a lograr tus objetivos de recursos humanos?</th>
                      <th class="align-middle text-center">¿Todo nuestro personal te asesora y atiende de manera profesional</th>
                      <th class="align-middle text-center">Cuando tienes alguna inconformidad u observación, ¿la atendemos de forma rápida y resolutiva?</th>
                ...
                <?php foreach($evaluations as $evaluation): ?>
                    <tr>
                        ...
                        <td class="text-center"><?=$evaluation['Objetivos']?></td>
                        <td class="text-center"><?=$evaluation['Asesoria']?></td>
                        <td class="text-center"><?=$evaluation['Resolucion']?></td>
