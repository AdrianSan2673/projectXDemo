                            ...
                            <div class="card-body">
                                <form role="form" id="psychometry-form">
                                    ...
                                    <input type="hidden" name="id_candidate" id="id_candidate"
                                        value="<?= isset($psycho) && is_object($psycho) ? $psycho->id_candidate : ''; ?>">
                                    <div class="form-group row">
                                        ...
                                        <input type="date" name="request_date" id="request_date" class="form-control"
                                            value="<?= isset($psycho) && is_object($psycho) ? $psycho->request_date : ''; ?>">
                                    </div>
                                    <?php endif ?>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first_name" id="first_name"
                                                    ...
                                                    value="<?= isset($psycho) && is_object($psycho) ? $psycho->first_name : ''; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="surname" id="surname" class="form-control"
                                                    required
                                                    value="<?= isset($psycho) && is_object($psycho) ? $psycho->surname : ''; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="last_name" id="last_name" class="form-control"
                                                    required
                                                    value="<?= isset($psycho) && is_object($psycho) ? $psycho->last_name : ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col">
                                            ...
                                            <input type="text" class="form-control" name="job_title" id="job_title"
                                                maxlength="100"
                                                value="<?= isset($psycho) && is_object($psycho) ? $psycho->job_title : ''; ?>">
                                        </div>
                                        <div class="form-group col">
                                            <label class="col-form-label" for="telephone">Teléfono</label>
                                            <input type="text" name="telephone" class="form-control" id="telephone"
                                                data-inputmask='"mask": "999 999 9999"' data-mask
                                                value="<?= isset($psycho) && is_object($psycho) ? $psycho->telephone : ''; ?>">
                                        </div>
                                        <div class="form-group col">
                                            <label class="col-form-label" for="email">Correo electrónico</label>
                                            <input type="email" name="email" id="email" class="form-control"
                                                value="<?= isset($psycho) && is_object($psycho) ? $psycho->email : ''; ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col">
                                            <div class="form-check">
                                                <input type="checkbox" name="behavior" value="1"
                                                    ...
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->behavior == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Comportamiento</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" name="intelligence" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->intelligence == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Inteligencia</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" name="labor_competencies" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->labor_competencies == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Competencias laborales</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" name="honesty_ethics_values" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->honesty_ethics_values == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Honestidad, ética y valores</label>
                                            </div>
                                        </div>
                                        <div class="form-group col">
                                            <div class="form-check">
                                                <input type="checkbox" name="personality" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->personality == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Personalidad</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" name="sales_skills" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->sales_skills == 1 ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Habilidades de ventas</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" name="leadership" value="1"
                                                    class="form-check-input"
                                                    <?= isset($psycho) && is_object($psycho) && $psycho->leadership == 1 ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="customer" id="customer" class="form-control" required>
                                            ...
                                            <option value="<?= $customer['id'] ?>"
                                                <?= isset($psycho) && is_object($psycho) && $customer['id'] == $psycho->id_customer ? 'selected' : ''; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="business_name" id="business_name" class="form-control">
                                            ...
                                            <option value="<?= $bn['id'] ?>"
                                                <?= isset($psycho) && is_object($psycho) && $bn['id'] == $psycho->id_business_name ? 'selected' : ''; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_date" id="end_date" class="form-control"
                                            value="<?= isset($psycho) && is_object($psycho) ? $psycho->end_date : ''; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="status" class="col-form-label">Estado:</label>
                                        <select name="status" id="status" class="select-box form-control">
                                            <option
                                                <?= isset($psycho) && is_object($psycho) && $psycho->status == 1 ? 'selected' : ''; ?>
                                                value="1">Pendiente</option>
                                            <option
                                                <?= isset($psycho) && is_object($psycho) && $psycho->status == 2 ? 'selected' : ''; ?>
                                                value="2">Entregada</option>
                                            <option
                                                <?= isset($psycho) && is_object($psycho) && $psycho->status == 3 ? 'selected' : ''; ?>
                                                value="3">Facturada</option>
                                            <option
                                                <?= isset($psycho) && is_object($psycho) && $psycho->status == 0 ? 'selected' : ''; ?>
                                                value="0">Cancelada</option>
                                        </select>
                                    </div>
                                    <?php endif ?>
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success float-right"
                                            id="submit">Editar</button>
                                        <?php else : ?>
                                        <button type="submit" class="btn btn-success float-right" id="submit">Registrar
                                            psicometría</button>
                                        <?php endif ?>
                                    </div>
                                </form>
