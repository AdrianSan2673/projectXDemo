<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if (!Utils::isCustomer() && ($psycho->status != 2 || $psycho->status != 3)) : ?>
                        <div class="card card-orange" hidden>
                            <div class="card-header">
            ...
            <?php if (Utils::isCustomer() && ($psycho->interpretation != '' || $psycho->interpretation != null)) : ?>
                ...
                <div class="card card-blue">
                    ...
                    <form id='interpretation-form'>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row " style="margin-bottom:0.6rem;padding:1rem">
                                <div class="col-md-12">
                                    <textarea class="form-control" name="interpretation" id="interpretation" rows="16" style="width: 100%;"><?= $psycho->interpretation ?></textarea>
                                </div>

                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-form-label" for="page">Paginas de logo</label>
                                        <input type="text" class="form-control" id="page" name="page" maxlength="100" value="<?= $psycho->page ?>" onkeypress="return soloLetras(event)" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="" id="form-document" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <input type="file" id="psycho_document" class="form-control" name="psycho_document" placeholder="Adjuntar archivo" class="form-control-file text-white" accept=" application/pdf">
                                </div>
