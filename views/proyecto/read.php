                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left mb-2">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url ?>proyecto/index">Proyectos</a></li>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table tablestriped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p class="title-departament" style='font-size: 17px;'><?= $proyecto->direccion ?> <?= $proyecto->Estado ?> </p>
                                            </td>
                                            <td>
...
window.onload = function() {
    ...
    //var proyecto = new Proyecto(); //Creo la instancia de la clase proyecto
