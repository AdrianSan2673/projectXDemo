            ...
            <?php else : ?>
              ...
              <div class="col-md-2">
                ...
                <select name="id_gender" id="id_gender" class="form-control">
                  <option value="" hidden selected>Sin filtro</option>
                  <option value="1" <?= isset($_POST['id_gender']) && $_POST['id_gender'] == 1 ? 'selected' : '';  ?>>
                    Masculino </option>
                  <option value="2" <?= isset($_POST['id_gender']) && $_POST['id_gender'] == 2 ? 'selected' : '';  ?>>
                    Femenino </option>
                </select>
              </div>
          ...
          <tbody>
            <?php foreach ($candidates as $candidate) : ?>
              <tr>
                ...
                <?php endif ?>
                <td><?= $candidate['first_name'] . ' ' . $candidate['surname'] . ' ' . $candidate['last_name'] ?>
                </td>
                <td><?= $candidate['age'] ?></td>
