                ...
                <div class="col-md-12">
                    ...
                    <form id="candidate-form" name="candidate-form" method="POST">
                        <input type="hidden" id="id"
                            value="<?= isset($candidato) && is_object($candidato) ? Encryption::encode($candidato->id) : '' ?>">

                        <?php if (isset($_GET['vacante'])) : ?>
                        <input type="hidden" name="id_vacancy" id="id_vacancy"
                            value="<?= isset($_GET['vacante']) && !empty($_GET['vacante']) ? $_GET['vacante'] : '' ?>">
                        <?php endif ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" id="first_name"
                                                        ...
                                                        value="<?= (isset($candidato) && is_object($candidato)) ? $candidato->first_name : ((isset($candidateDirectory)) ? $candidateDirectory->first_name : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="surname" id="surname" class="form-control"
                                                        required
                                                        value="<?= (isset($candidato) && is_object($candidato)) ? $candidato->surname : ((isset($candidateDirectory)) ? $candidateDirectory->surname : '');; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_name" id="last_name"
                                                        class="form-control" required
                                                        value="<?= (isset($candidato) && is_object($candidato)) ? $candidato->last_name : ((isset($candidateDirectory)) ? $candidateDirectory->last_name : '');; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date_birth" id="date_birth"
                                                        class="form-control"
                                                        value="<?= isset($candidato) && is_object($candidato) ? $candidato->date_birth : ''; ?>">
                                                </div>
                                            </div>
                                            <!-- gabo 18 abril vacante -->
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="age" id="age" class="form-control"
                                                        value="<?= isset($candidato) && is_object($candidato) ? $candidato->age : ''; ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_gender" id="id_gender" class="form-control">
                                                        ...
                                                        <option value="<?= $gender['id'] ?>"
                                                            <?= isset($candidato) && is_object($candidato) && $gender['id'] == $candidato->id_gender ? 'selected' : ''; ?>>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_civil_status" id="id_civil_status"
                                                        class="form-control">
                                                        <option value>Selecciona el estado civil</option>
                                                        <?php foreach ($civil_status as $status) : ?>
                                                        <option value="<?= $status['id'] ?>"
                                                            <?= isset($candidato) && is_object($candidato) && $status['id'] == $candidato->id_civil_status ? 'selected' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_level" id="id_level" class="form-control" required>
                                                ...
                                                <option value="<?= $level['id'] ?>"
                                                    <?= isset($candidato) && is_object($candidato) && $level['id'] == $candidato->id_education_level ? 'selected' : ''; ?>>
                                                    <?= $level['level'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="job_title" id="job_title" class="form-control"
                                                required
                                                value="<?= (isset($candidato) && is_object($candidato)) ? $candidato->job_title : ((isset($candidateDirectory)) ? $candidateDirectory->experience : '');; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                class="form-control"><?= isset($candidato) && is_object($candidato) ? $candidato->description : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="id_area" id="id_area" class="form-control" required>
                                                ...
                                                <option value="<?= $area['id'] ?>"
                                                    <?= isset($candidato) && is_object($candidato) && ($area['id'] == $candidato->id_area) ?  'selected' : ''; ?>>
                                                    <?= $area['area'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_subarea" id="id_subarea" class="form-control" required>
                                                ...
                                                <option value="<?= $subarea['id'] ?>"
                                                    <?= isset($candidato) && is_object($candidato) && $subarea['id'] == $candidato->id_subarea ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cellphone" id="cellphone" maxlength="13"
                                                class="form-control"
                                                value="<?= isset($candidato) && is_object($candidato) ? $candidato->cellphone : ''; ?>"
                                                data-inputmask='"mask": "999 999  9999"' data-mask>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" readonly
                                                value="<?= $_SESSION['identity']->email ?>" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <?php else : ?>
                                    ...
                                    <div class="col-md-4"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" required
                                                value="<?= isset($candidato) && is_object($candidato) ? $candidato->email : ''; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="id_state" id="id_state" class="form-control"
                                                ...
                                                <option value="<?= $state['id'] ?>"
                                                    <?= isset($candidato) && is_object($candidato) && $state['id'] == $candidato->id_state ? 'selected' : ''; ?>>
                                                    <?= $state['state'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_city" id="id_city" class="form-control select2bs4"
                                                ...
                                                <option value="<?= $city['id'] ?>"
                                                    <?= isset($candidato) && is_object($candidato) && $city['id'] == $candidato->id_city ? 'selected' : ''; ?>>
                                                    <?= $city['city'] ?></option>
                                                <?php endforeach ?>
                                                <?php else : ?>
                                                <option disabled selected="selected"></option>
                                ...
                                <div class="row" style="display: <?= !Utils::isCandidate() ? 'none' : 'flex' ?>;">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="linkedinn" id="linkedinn" class="form-control"
                                                value="<?= isset($candidato) && is_object($candidato) ? $candidato->linkedinn : ''; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facebook" id="facebook" class="form-control"
                                                value="<?= isset($candidato) && is_object($candidato) ? $candidato->facebook : ''; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="instagram" id="instagram" class="form-control"
                                                value="<?= isset($candidato) && is_object($candidato) ? $candidato->instagram : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
