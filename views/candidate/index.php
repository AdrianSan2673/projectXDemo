<div class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left mb-2">
                        ...
                        <?php else : ?>
                        <li class="breadcrumb-item"><a
                                href="<?= base_url . "postulaciones/buscar&id=" . $_GET['id'] . "&area=" . Utils::encrypt($vacante->id_area) ?>">Candidatos
    ...
    <section class="content-header">
        ...
        <div class="row">
            ...
            <?php else : ?>
            <a href="<?= base_url ?>postulaciones/buscar&id=<?= $_GET['id'] ?>&area=<?= Encryption::encode($vacante->id_area) ?>"
                class="btn btn-info btn-lg mx-auto">Buscar por área</a>
            <?php endif ?>
        </div>
        <div class="row mt-3">
                            ...
                            <div id="collapseArea" class="panel-collapse collapse in">
                                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="area[]" id="area<?= $area['id'] ?>"
                                            class="form-check-input" value="<?= $area['id'] ?>">
                                        <label for="area<?= $area['id'] ?>"
                                            class="form-check-label"><?= $area['area'] ?></label>
                                    </div>
                                    <?php endforeach ?>
                                </div>
                            </div>
                        ...
                        <div class="card card-maroon">
                            ...
                            <div id="collapseState" class="panel-collapse collapse in">
                                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="state" id="state<?= $state['id'] ?>"
                                            class="form-check-input" value="<?= $state['id'] ?>">
                                        <label for="state<?= $state['id'] ?>"
                                            class="form-check-label"><?= $state['state'] ?></label>
                                    </div>
                                    <?php endforeach ?>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="gender" id="gender<?= $gender['id'] ?>"
                                            class="form-check-input" value="<?= $gender['id'] ?>">
                                        <label for="gender<?= $gender['id'] ?>"
                                            class="form-check-label"><?= $gender['gender'] ?></label>
                                    </div>
                                    <?php endforeach ?>
                                </div>
                            </div>
        ...
        <div class="card">
                        ...
                        <form method="POST"
                            ...
                            <?php endif; ?> <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="" name="clave" id="clave"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_level" id="id_level" class="form-control filtro">
                                        ...
                                        <option value="<?= $level['id'] ?>"
                                            <?= isset($_POST['id_level']) && $level['id'] == $_POST['id_level']    && isset($_POST['clave']) && $_POST['clave'] == ""  ? 'selected' : ''; ?>>
                                            <?= $level['level'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_area" id="id_area" class="form-control filtro">
                                        ...
                                        <option value="<?= $area['id'] ?>"
                                            <?= isset($_POST['id_area']) && $area['id'] == $_POST['id_area']  && isset($_POST['clave']) && $_POST['clave'] == ""   ? 'selected' : ''; ?>>
                                            <?= $area['area'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_subarea" id="id_subarea" class="form-control filtro">
                                        ...
                                        <option value="<?= $subarea['id'] ?>"
                                            <?= isset($_POST['id_subarea']) && $subarea['id'] == $_POST['id_subarea']   && isset($_POST['clave']) && $_POST['clave'] == ""  ? 'selected' : ''; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_state" id="id_state" class="form-control filtro"
                                        ...
                                        <option value="<?= $state['id'] ?>"
                                            <?= isset($_POST['id_state']) && $state['id'] == $_POST['id_state']  && isset($_POST['clave']) && $_POST['clave'] == ""   ? 'selected' : ''; ?>>
                                            <?= $state['state'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_city" id="id_city" class=" form-control  filtro"
                                        ...
                                        <option value="<?= $city['id'] ?>"
                                            <?= isset($_POST['id_city'])  && $city['id'] == $_POST['id_city']  && isset($_POST['clave']) && $_POST['clave'] == ""   ? 'selected' : ''; ?>>
                                            <?= $city['city'] ?></option>
                                        <?php endforeach ?>
                                        <?php else : ?>
                                        <option disabled selected="selected"></option>
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="language" id="language" class="form-control filtro">
                                    ...
                                    <option value="<?= $language['id'] ?>"
                                        <?= isset($_POST['language']) && $language['id'] == $_POST['language']  && isset($_POST['clave']) && $_POST['clave'] == "" ? 'selected' : ''; ?>>
            ...
            <div class="card-body">
                ...
                <div class="table-respsonsive">
                    <table id="tb_candidates" class="table table-striped table-respsonsive"
...
$(document).ready(function() {
    ...
    //modal-vacantes
    // function open_vacancies(id_candidato, id_usuario, nombre) {
    //     document.querySelector("#add-candidate-form #nombre_candidato").innerHTML = nombre;
    //     $('#add-candidate-form #id_candidato_v').val(id_candidato);
    ...
    //     applicant.getVacanciesByCandidato(id_candidato, id_usuario);

    //     $('#modal_vacantes').modal({
    //         backdrop: 'static',
    //         keyboard: false
    //     });
    ...
    document.querySelector('#tb_candidates').addEventListener('click', function(e) {
        ...
        if (e.target.classList.contains('btn-warning') || e.target.offsetParent.classList.contains(
            ...
            // document.querySelector("#titulo-postular").innerHTML = candidate;
            // $('#modal_postulate').modal({
            //     backdrop: 'static',
            //     keyboard: false
            // });
            ...
            document.querySelector("#add-candidate-form #nombre_candidato").innerHTML = candidate;
            $('#add-candidate-form #id_candidato_v').val(id_candidate);
            document.getElementById("add-candidate-form").reset();

            $("#id_vacancy_v").val("");
            $('#id_vacancy_v').trigger('change');

            // let id_recuiter = document.querySelector("#add-candidate-form #id_recruiter").value;

            let applicant = new Applicant();
            applicant.getVacanciesByCandidato(id_candidate);
