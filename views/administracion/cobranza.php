                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col">
                                    ...
                                    <p class="info-box-number"><?= '$' . number_format($total_facturado_mensual, 2) ?>
                                    </p>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <p class="info-box-number">
                                        <?= $total_cobrado_mensual > 0 ? number_format($total_cobrado_mensual / $total_facturado_mensual * 100, 2) : '0' . '%' ?>
                                    </p>
                                </div>
                                <div class="col">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col">
                                    <span class="card-text">Facturado</span>
                                    <p class="info-box-number">
                                        <?= '$' . number_format($total_facturado_mes_anterior, 2) ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <span class="card-text">Cobrado</span>
                                    <p class="info-box-number">
                                        <?= '$' . number_format($total_cobrado_mes_anterior, 2) ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <p class="info-box-number">
                                        <?= number_format($total_cobrado_mes_anterior / $total_facturado_mes_anterior * 100, 2) . '%' ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <span class="card-text">Operaciones facturadas</span>
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col">
                                    <span class="card-text">Facturado</span>
                                    <p class="info-box-number">
                                        <?= '$' . number_format($total_facturado_mes_tras_anterior, 2) ?></p>
                                </div>
                                <div class="col">
                                    <span class="card-text">Cobrado</span>
                                    <p class="info-box-number">
                                        <?= '$' . number_format($total_cobrado_mes_tras_anterior, 2) ?></p>
                                </div>
                                <div class="col">
                                    <p class="info-box-number">
                                        <?= number_format($total_cobrado_mes_tras_anterior / $total_facturado_mes_tras_anterior * 100, 2) . '%' ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <span class="card-text">Operaciones facturadas</span>
                                    <p class="info-box-number"><?= $total_operaciones_facturadas_mes_tras_anterior ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <div class="col">
                                    <p class="info-box-number">
                                        <?= $total_cobrado_anual > 0 ? number_format($total_cobrado_anual / $total_facturado_anual * 100, 2) : '0' . '%' ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <span class="card-text">Operaciones facturadas</span>
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills">
                    ...
                    <!-- // ===[gabo 16 agosto ]=== -->
                    <li class="nav-item">
                        <a class="nav-link  <?= (!isset($_POST['search'])) ? 'active' : ''; ?>" href="#tab_1" data-toggle="tab">Facturas pendientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= (isset($_POST['search'])) ? 'active' : ''; ?>" href="#tab_2" data-toggle="tab">Facturas pagadas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_3" data-toggle="tab">Facturas canceladas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_4" data-toggle="tab">Facturas incobrables</a>
                    </li>
                    <!-- // ===[gabo 16 agosto ]=== -->
            ...
            <div class="card-body">
                <div class="tab-content">
                    <!-- // ===[gabo 16 agosto ]=== -->
                    <div class="tab-pane <?= (!isset($_POST['search'])) ? 'active' : ''; ?>" id="tab_1">
                        <!-- // ===[gabo 16 agosto ]=== -->
                                ...
                                <?php foreach ($facturas_pendientes as $bill) : ?>
                                    <tr id="factura<?= $bill['Folio_Factura'] ?>">
                                        ...
                                        <td class="text-center align-middle">
                                            <?= Utils::getShortDate($bill['Fecha_Emision']); ?></td>
                                        ...
                                        <td class="text-center align-middle">
                                            <?= !is_null($bill['Fecha_de_Pago']) ? Utils::getShortDate($bill['Fecha_de_Pago']) : '' ?>
                                        </td>
                    ...
                    <!-- // ===[gabo 16 agosto ]=== -->
                    <div class="tab-pane <?= (isset($_POST['search'])) ? 'active' : ''; ?>" id="tab_2">

                        <section class="content-header">
                            <form method="POST" action="<?= base_url . "administracion_SA/cobranza" ?>">
                                <div class="d-flex flex-row justify-content-center alig-items-center">
                                    <div class="row" style="width:50%;">

                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="fecha incio" class="col-form-label">Fecha Inicio</label>
                                                <input type="date" name="fecha_inicio" id="fecha_inicio" max="<?= date('Y-m-d') ?>" value="<?= (isset($_POST['fecha_inicio'])) ? $_POST['fecha_inicio'] : date("Y-m-d", strtotime(date("Y") . "-01-01" . "- 1 year")); ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="fecha_fin" id="fecha_fin" max="<?= date('Y-m-d') ?>" value="<?= (isset($_POST['fecha_fin'])) ? $_POST['fecha_fin'] :  date("Y") . "-01-01" ?>" class="form-control">
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                <?php foreach ($facturas_pagadas as $bill) : ?>
                                    <tr id="factura<?= $bill['Folio_Factura'] ?>">
                                        ...
                                        <td class="text-center align-middle"><?= $bill['Nombre_Empresa'] ?></td>
                                        <td class="text-center align-middle"><?= $bill['Cliente'] ?></td>
                                        <td id="razon<?= $bill['Folio_Factura'] ?>" class="align-middle">
                                            <?= $bill['Razon_Social'] ?></td>
                                        <td class="text-right align-middle">$ <?= number_format($bill['Monto'], 2) ?></td>
                                        <td class="text-right align-middle">$ <?= number_format($bill['Monto_IVA'], 2) ?>
                                        </td>
                                        <td class="text-center align-middle">
                    ...
                    <div class="tab-pane " id="tab_3">
                        ...
                        <div class="table-responsive">
                            <table id="tb_paid_bills_canhcel" class="table table-striped table-xl" style="display: none;">
                                <!-- gabo 16 agosto -->
                                <thead>
                                    <tr>
                                        <th></th>
                                ...
                                <tbody>
                                    <?php foreach ($facturas_canceladas as $bill) : ?>
                                        <tr id="factura<?= $bill['Folio_Factura'] ?>">
                                            ...
                                            <td class="text-center align-middle"><?= $bill['Nombre_Empresa'] ?></td>
                                            <td class="text-center align-middle"><?= $bill['Cliente'] ?></td>
                                            <td id="razon<?= $bill['Folio_Factura'] ?>" class="text-center align-middle">
                                                <?= $bill['Razon_Social'] ?></td>
                                            <td class="text-right align-middle">$ <?= number_format($bill['Monto'], 2) ?>
                                            </td>
                                            <td class="text-right align-middle">$
                                                <?= number_format($bill['Monto_IVA'], 2) ?>
                                            </td>
                                            <td class="text-center align-middle">
                                                <?= !is_null($bill['Fecha_de_Pago']) ? Utils::getShortDate($bill['Fecha_de_Pago']) : '' ?>
                                            </td>
                                            <td id="estado<?= $bill['Folio_Factura'] ?>" class="text-center align-middle <?= $class_color ?>"><?= $bill['Estado'] ?>
                                            </td>

                                            <td class="text-center align-middle">
                                                <?= !is_null($bill['fecha_cancelacion']) ? Utils::getShortDate($bill['fecha_cancelacion']) : '' ?>
                                            </td>
                                            <td class="text-center align-middle"><?= $bill['comentarios'] ?>
                                            </td>
                                            <td class="text-center py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="<?= base_url ?>administracion_SA/editar_factura&folio=<?= Encryption::encode($bill['Folio_Factura']) ?>" class="btn btn-success btn-sm mr-1">
                                                    ...
                                                    <button class="btn btn-info btn-sm mr-1" data-id="<?= Encryption::encode($bill['Folio_Factura']) ?>">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </button>
                    ...
                    <div class="tab-pane" id="tab_4">
                        <!-- // ===[gabo 16 agosto ]=== -->
                        <table id="tb_paid_bills_incobrables" class="table table-responsive table-striped table-sm" style="display: none;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th></th>
                            ...
                            <tbody>
                                <?php foreach ($facturas_incobrables as $bill) : ?>
                                    <tr id="factura<?= $bill['Folio_Factura'] ?>">
                                        <?php
                                        switch ($bill['Estado']) {
                                            case 'Pendiente de pago':
...
<script>
    $(document).ready(function() {
        ...
        let table4 = document.querySelector('#tb_paid_bills_incobrables');
        table4.style.display = "table";
        utils.dtTable(table4, false);
        ...
        table3.addEventListener('click', e => {
            if (e.target.classList.contains('btn-info') || e.target.offsetParent.classList.contains(
                ...
                let administracion = new Administracion();
                administracion.getInfoCancel(folio);
            }
        ...
        table4.addEventListener('click', e => {
            if (e.target.classList.contains('btn-info') || e.target.offsetParent.classList.contains(
                    'btn-info')) {
                $('#modal_factura').modal('show');
                let folio;
